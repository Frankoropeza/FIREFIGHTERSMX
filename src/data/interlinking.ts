...
export const interlinking: Record<string, NodoRel> = {
  ...
  '/productos/equipos-scba/': { hermanas: [producto('cascos-nfpa', 'Cascos NFPA'), producto('camaras-termicas', 'Cámaras térmicas'), detectoresGas], servicios: [mantenimiento, servicio('capacitacion', 'Capacitación contra incendio')], industrias: [industria('bomberos-municipales', 'Equipo para bomberos municipales')], marcas: [marca('3m-scott', '3M Scott'), marca('msa-safety', 'MSA Safety'), marca('drager', 'Dräger')] },
