...
export const interlinking: Record<string, NodoRel> = {
  ...
  '/productos/sistemas-ci/alarma-contra-incendio/': { hermanas: [tyco, notifier, red, agentes], servicios: [instalacion, mantenimiento, auditoria], industrias: [industria('hospitales', 'Alarmas contra incendio para hospitales'), industria('hoteles', 'Alarmas contra incendio para hoteles')], guias: [deteccionGuia, nomGuia], marcas: [{ href: '/marcas/honeywell/', label: 'Marca Honeywell' }] },
  '/productos/sistemas-ci/tyco-viking/': { hermanas: [alarma, notifier, agentes, red], servicios: [instalacion, mantenimiento], industrias: [industria('hoteles', 'Rociadores para hoteles'), industria('hospitales', 'Rociadores para hospitales')], guias: [deteccionGuia] },
  ...
  '/productos/sistemas-ci/red-hidraulica/': { hermanas: [alarma, tyco, notifier, agentes], servicios: [instalacion, mantenimiento], industrias: [industria('hospitales', 'Red hidráulica para hospitales'), industria('hoteles', 'Red hidráulica para hoteles')], guias: [nomGuia] },
  ...
  '/servicios/mantenimiento/': { hermanas: [instalacion, auditoria], industrias: [industria('hoteles', 'Mantenimiento para hoteles')], guias: [guia('tipos-de-extintores-mexico', 'Tipos de extintores en México')] },
  '/servicios/instalacion-sistemas-ci/': { hermanas: [mantenimiento, auditoria], industrias: [industria('hospitales', 'Instalación para hospitales'), industria('hoteles', 'Instalación para hoteles')], guias: [deteccionGuia, nomGuia], marcas: [alarma, tyco, notifier] },
  ...
  '/industrias/hospitales/': { hermanas: [industria('hoteles', 'Sistemas contra incendio para hoteles')], servicios: [instalacion, mantenimiento, auditoria], guias: [deteccionGuia, nomGuia], marcas: [alarma, notifier, tyco] },
  '/industrias/hoteles/': { hermanas: [industria('hospitales', 'Sistemas contra incendio para hospitales')], servicios: [instalacion, mantenimiento], guias: [deteccionGuia], marcas: [alarma, tyco] },
  '/industrias/refinerias-pemex/': { hermanas: [industria('mineria', 'Protección contra incendio para minería')], servicios: [instalacion, servicio('capacitacion', 'Capacitación contra incendio')], marcas: [agentes, producto('hazmat', 'Equipos HAZMAT')] },
  ...
  '/blog/nom-002-stps-guia-completa/': { hermanas: [guia('tipos-de-extintores-mexico', 'Tipos de extintores en México'), deteccionGuia], servicios: [auditoria, instalacion], industrias: [industria('brigadas-industriales', 'Cumplimiento para brigadas industriales')], marcas: [alarma, sistemas] },
