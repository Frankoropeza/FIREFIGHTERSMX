...
const NOTA_TIC =
  '* Cámaras de imagen térmica para servicio de bomberos certificadas NFPA 1801 (modelos estructurales). Resolución del sensor en píxeles; rango de temperatura y autonomía nominales según modelo y uso.';
...
const flir: EquipmentBrand = {
  ...
  brand: 'FLIR',
  brandLabel: 'FLIR',
  crossDesc: 'Líder mundial en imagen térmica · K-Series · FSX · NFPA 1801',
  eyebrow: 'FLIR · Imagen Térmica · Distribuidor Autorizado MX',
  heroTitleTop: 'Cámaras FLIR',
  heroTitleAccent: 'imagen térmica NFPA.',
  heroLead:
    'Distribuidor autorizado de cámaras térmicas FLIR en México. Las 4 categorías —búsqueda y rescate, personal, mando e inspección industrial— con tecnología FSX, certificación NFPA 1801 y entrega en CDMX.',
  heroIntro: [
    ...
    'En visibilidad cero, la imagen térmica es la diferencia entre buscar y encontrar. Distribuimos la gama FLIR certificada NFPA 1801 —desde la cámara personal de bolsillo hasta el modelo de mando con grabación— más cámaras de inspección industrial de alta resolución.',
  ],
  heroBadges: ['NFPA 1801', 'FSX', '320×240 px', 'Grabación', 'Líder mundial TIC', 'Distribuidor autorizado MX'],
  seoTitle: 'Cámaras Térmicas FLIR NFPA 1801 — K-Series · México',
  seoDescription:
    'Cámaras térmicas FLIR certificadas NFPA 1801 en México: K45 búsqueda y rescate, K1 personal, K65 mando e inspección industrial T560. Tecnología FSX. Distribuidor autorizado · stock CDMX.',
  founding: '1978',
  parentOrg: { name: 'Teledyne FLIR LLC' },
  stats: [
    { valor: 'Líder', etiq: 'Mundial en imagen térmica' },
    { valor: 'FSX', etiq: 'Realce de escena en tiempo real' },
    { valor: 'NFPA 1801', etiq: 'Certificación de imagen térmica' },
  ...
  credenciales: [
    ...
    { n: '04', t: 'Certificación NFPA 1801 y stock CDMX', d: 'Los modelos estructurales cumplen NFPA 1801 —el estándar que garantiza legibilidad, durabilidad e interfaz uniforme en combate. Stock de los modelos clave con entrega en 24–48 h y demostración en sitio sin costo.' },
  ],
  linesIntro:
  ...
  lineas: [
    { tipo: 'estructural', badge: 'NFPA 1801 · 320×240', titulo: 'Búsqueda y Rescate', modelos: 'FLIR K45', desc: 'La cámara estructural de referencia para localización de víctimas y orientación en humo. Sensor de 320×240 px con FSX, pantalla de alto brillo y carcasa que resiste caída de 2 m e inmersión IP67.', tech: 'FSX · 320×240 px · -20 a 650 °C · IP67 · NFPA 1801' },
    { tipo: 'usar', badge: 'NFPA 1801 · Personal', titulo: 'Cámara Personal', modelos: 'FLIR K1', desc: 'Cámara de bolsillo para dotar a cada bombero de visión en humo. Compacta, con linterna LED de 500 lúmenes integrada y encendido en menos de 5 segundos. Conciencia situacional por elemento.', tech: 'Bolsillo · 160×120 px · LED 500 lm · IP67 · NFPA 1801' },
    { tipo: 'mando', badge: 'NFPA 1801 · Grabación', titulo: 'Mando y Documentación', modelos: 'FLIR K65', desc: 'El modelo premium con grabación de video e imágenes y transmisión Bluetooth a tablet de mando. Rango extendido hasta 1000 °C para fuego desarrollado y modos de color para sobrehaul.', tech: 'Grabación · Bluetooth · 320×240 px · -20 a 1000 °C' },
  ...
  guia: [
    ...
    { n: '04', t: 'Verifica certificación NFPA 1801 en los modelos estructurales, define grabación/streaming si necesitas documentación, y agenda demostración en sitio sin costo para que la brigada la pruebe antes de decidir.' },
  ],
  segmentosIntro:
    'FLIR es la primera opción de los cuerpos que priorizan la calidad de imagen y el detalle de escena (FSX), con una gama que va de la cámara personal al mando, más inspección industrial — con certificación NFPA 1801 y soporte en los 32 estados.',
  segmentos: [
  ...
  faqs: [
    { q: '¿Qué norma certifica una cámara térmica para el servicio de bomberos?', a: 'La NFPA 1801 es el estándar para cámaras de imagen térmica del servicio de incendios: define requisitos de imagen, legibilidad, durabilidad (caída, calor, agua) e interfaz uniforme para que cualquier bombero pueda operar cualquier cámara certificada bajo estrés. Los modelos estructurales FLIR K cumplen NFPA 1801; las cámaras de inspección industrial (serie T) siguen estándares de medición industrial, no NFPA 1801, porque su uso es distinto.' },
...
const msaEvolution: EquipmentBrand = {
  ...
  crossDesc: 'Integración SCBA G1 · manos libres · NFPA 1801',
  eyebrow: 'MSA Safety · Evolution · Distribuidor Autorizado MX',
  heroTitleTop: 'Cámaras MSA',
  heroTitleAccent: 'Evolution NFPA.',
  heroLead:
    'Distribuidor autorizado de cámaras térmicas MSA Evolution en México. Las 4 categorías —búsqueda y rescate, integrada en SCBA G1, mando e industrial— con certificación NFPA 1801 y servicio técnico autorizado.',
  heroIntro: [
    ...
    'Su mayor diferenciador es la G1-TIC: una cámara térmica montada en la máscara del SCBA G1 que proyecta la imagen en la pieza facial y deja ambas manos libres para el rescate. Distribuimos la gama Evolution certificada NFPA 1801 con servicio técnico autorizado.',
  ],
  heroBadges: ['NFPA 1801', 'Integración G1', 'Manos libres', 'Ecosistema MSA', 'MSA Safety · NYSE', 'Distribuidor autorizado MX'],
  seoTitle: 'Cámaras Térmicas MSA Evolution NFPA 1801 — México',
  seoDescription:
    'Cámaras térmicas MSA Evolution certificadas NFPA 1801 en México: Evolution 6000 búsqueda, G1-TIC integrada en SCBA, mando 6000 Plus e industrial 5200. Ecosistema MSA. Distribuidor autorizado · servicio.',
  founding: '1914',
  ...
  credenciales: [
    ...
    { n: '04', t: 'Servicio técnico autorizado', d: 'Somos servicio autorizado MSA: calibración, verificación de imagen NFPA 1801 y refacciones originales con bitácora para auditoría. Tu inversión queda protegida toda la vida útil del equipo.' },
  ],
  linesIntro:
  ...
  lineas: [
    { tipo: 'estructural', badge: 'NFPA 1801 · 320×240', titulo: 'Búsqueda y Rescate', modelos: 'MSA Evolution 6000', desc: 'La cámara estructural de la línea Evolution: sensor de 320×240 px, pantalla de alto contraste legible en humo denso y diseño robusto para combate, operable con un solo botón y con guante puesto.', tech: 'Evolution 6000 · 320×240 px · Alto contraste · NFPA 1801' },
    { tipo: 'usar', badge: 'NFPA 1801 · Integrada G1', titulo: 'Integrada en SCBA G1', modelos: 'MSA G1-TIC', desc: 'La diferencia MSA: cámara térmica montada en la máscara del SCBA G1, con la imagen proyectada en la pieza facial. Manos libres para rescate y avance, sin equipo adicional que cargar o soltar.', tech: 'En máscara G1 · Manos libres · 160×120 px · Alimentación G1' },
    { tipo: 'mando', badge: 'NFPA 1801 · Grabación', titulo: 'Mando y Documentación', modelos: 'MSA Evolution 6000 Plus', desc: 'Versión de mando con grabación de incidentes y transmisión inalámbrica para conciencia situacional del comandante. Rango extendido y modos de color para documentación y sobrehaul.', tech: 'Grabación · Transmisión · 320×240 px · -20 a 1000 °C' },
    { tipo: 'industrial', badge: 'NFPA 1801 · Acceso', titulo: 'Industrial / Acceso', modelos: 'MSA Evolution 5200', desc: 'Cámara confiable de la línea Evolution para brigadas industriales y de Protección Civil con presupuesto controlado. Imagen NFPA 1801 para búsqueda y verificación de puntos calientes en planta.', tech: 'Evolution 5200 · 160×120 px · Costo accesible · NFPA 1801' },
  ],
  ...
  anatomia: [
    ...
    { t: 'Servicio y calibración', d: 'Verificación de imagen NFPA 1801, calibración y refacciones originales con servicio técnico autorizado y bitácora para auditoría.' },
  ],
  comparativa: [
  ...
  guia: [
    ...
    { n: '04', t: 'Asegura la verificación NFPA 1801, la calibración periódica con servicio autorizado y la compatibilidad con tu casco, SCBA y comunicación. Agenda demostración en sitio sin costo.' },
  ],
  segmentosIntro:
  ...
  segmentos: [
    ...
    { num: '04', tipo: 'industrial', titulo: 'Industria y Protección Civil', desc: 'Brigadas industriales y de Protección Civil con presupuesto controlado que necesitan imagen NFPA 1801 confiable para búsqueda y verificación de puntos calientes. La 5200 es la entrada de la línea.', modelos: 'MSA Evolution 5200' },
  ],
  faqs: [
    { q: '¿Qué norma certifica una cámara térmica para el servicio de bomberos?', a: 'La NFPA 1801, que define requisitos de imagen, legibilidad, durabilidad e interfaz uniforme para que cualquier bombero pueda operar cualquier cámara certificada bajo estrés. Los modelos estructurales MSA Evolution cumplen NFPA 1801. La configuración G1-TIC se integra al SCBA G1 conforme al ecosistema MSA.' },
...
const bullardTxs: EquipmentBrand = {
  ...
  crossDesc: 'Interfaz intuitiva · montaje en casco · NFPA 1801',
  eyebrow: 'Bullard · Cámaras Térmicas · Distribuidor Autorizado MX',
  heroTitleTop: 'Cámaras Bullard',
  heroTitleAccent: 'imagen térmica NFPA.',
  heroLead:
    'Distribuidor autorizado de cámaras térmicas Bullard en México. Las 4 categorías —búsqueda y rescate, personal, mando e industrial— con la interfaz más intuitiva del mercado, montaje en casco Bullard y certificación NFPA 1801.',
  heroIntro: [
    ...
    'Su sello es la interfaz: la curva de aprendizaje más corta del mercado, para que cualquier elemento opere la cámara bajo estrés sin menús complejos. Distribuimos la gama Bullard certificada NFPA 1801, de la TXS tope de gama a la QXT personal.',
  ],
  heroBadges: ['NFPA 1801', 'Montaje en casco', 'Interfaz intuitiva', 'Pantalla 3.5"', 'Desde 1898', 'Distribuidor autorizado MX'],
  seoTitle: 'Cámaras Térmicas Bullard NFPA 1801 — TXS · México',
  seoDescription:
    'Cámaras térmicas Bullard certificadas NFPA 1801 en México: TXS tope de gama, QXT personal, T4MAX mando y Eclipse industrial. Interfaz intuitiva y montaje en casco. Distribuidor autorizado · stock CDMX.',
  founding: '1898',
  ...
  credenciales: [
    ...
    { n: '04', t: 'Certificación NFPA 1801 y stock CDMX', d: 'Los modelos estructurales cumplen NFPA 1801. Stock de los modelos clave con entrega en 24–48 h, demostración en sitio sin costo y servicio de calibración y verificación.' },
  ],
  linesIntro:
  ...
  lineas: [
    { tipo: 'estructural', badge: 'NFPA 1801 · 320×240', titulo: 'Búsqueda y Rescate', modelos: 'Bullard TXS', desc: 'El tope de gama Bullard: pantalla de 3.5\" de alta resolución, sensor de 320×240 px y la interfaz más intuitiva del mercado. Mango ergonómico intercambiable y montaje compatible con casco Bullard.', tech: 'TXS · Pantalla 3.5" · 320×240 px · Montaje casco · NFPA 1801' },
    { tipo: 'usar', badge: 'NFPA 1801 · Personal', titulo: 'Cámara Personal', modelos: 'Bullard QXT', desc: 'Cámara compacta y económica para dotar a más elementos del cuerpo manteniendo la calidad de imagen Bullard. Operación de un botón con guante y resistente a impactos y agua.', tech: 'QXT · Compacta · 160×120 px · Económica · NFPA 1801' },
    { tipo: 'mando', badge: 'NFPA 1801 · Grabación', titulo: 'Mando y Documentación', modelos: 'Bullard T4MAX', desc: 'Cámara con grabación de video e imágenes para mando y análisis. Pantalla amplia, modos de color y captura de incidentes para documentación y revisión táctica posterior.', tech: 'T4MAX · Grabación · 320×240 px · Modos de color' },
  ...
  guia: [
    ...
    { n: '04', t: 'Verifica certificación NFPA 1801 en los modelos estructurales, agenda demostración en sitio sin costo y define el plan de calibración y verificación con servicio autorizado.' },
  ],
  segmentosIntro:
    'Bullard es la primera opción de los cuerpos que valoran la simplicidad de uso y ya operan cascos Bullard —por el montaje en casco nativo y la interfaz más intuitiva del mercado—, con certificación NFPA 1801 y soporte en los 32 estados.',
  segmentos: [
  ...
  faqs: [
    ...
    { q: '¿Por qué se insiste tanto en la interfaz de la cámara?', a: 'Porque en la zona caliente, con guante, humo y estrés, una interfaz compleja cuesta segundos que el bombero no tiene. El sello Bullard es la curva de aprendizaje más corta del mercado: operación de un botón y menús mínimos, para que cualquier elemento use la cámara correctamente bajo presión. La NFPA 1801 precisamente busca esa uniformidad y simplicidad de operación.' },
    { q: '¿Qué diferencia a Bullard de FLIR y MSA Evolution?', a: 'Las tres son marcas tier-1 de imagen térmica NFPA 1801. Bullard destaca por la simplicidad de su interfaz y por el montaje en casco nativo (también fabrica cascos); FLIR sobresale por la calidad pura de sensor y FSX; MSA Evolution por la integración con el SCBA G1 (manos libres en la máscara). Para un cuerpo que prioriza facilidad de uso y ya opera cascos Bullard, esta marca tiene la ventaja. Te facilitamos las tres fichas para evaluación comparativa.' },
    ...
    { q: '¿Entregan ficha técnica, demostración y servicio para licitación?', a: 'Sí. Cada cámara Bullard incluye la ficha técnica, la certificación NFPA 1801 (modelos estructurales) y carta de garantía. Ofrecemos demostración en sitio sin costo y, para concursos públicos (CompraNet, IMSS, Pemex, gobiernos estatales), generamos el manifiesto de cumplimiento por partida y el plan de calibración y verificación.' },
  ],
  ctaKicker: 'La interfaz más simple · montaje en casco',
  ctaTitleHtml: 'Simple de usar.<br/>Imposible de soltar.',
  waQuote: 'Hola, quiero cotizar cámaras térmicas Bullard NFPA 1801.',
};
