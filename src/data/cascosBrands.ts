...
const msaGallet: CascoBrand = {
  ...
  heroIntro: [
    ...
    'El F1 XF y F1 XF Comandante cumplen EN 443 y EN 14458. Para EVOGUARD, F1 EVO, F1 XF ARFF, F1 SF y F1 SF Pro, consulta la norma aplicable en el certificado del modelo; el F2 X-TREM mantiene EN 16471/16473.',
  ],
  ...
  seoDescription:
    'Cascos MSA Gallet en México: F1 XF y Comandante con EN 443 y EN 14458; F2 X-TREM con EN 16471/16473. Consulta la norma de otros modelos en su certificado. Distribuidor autorizado · stock CDMX · ficha para licitación.',
  founding: '1865',
  ...
  lineas: [
    { tipo: 'estructural', badge: 'Consulta norma por modelo', titulo: 'Línea Estructural', modelos: '4 modelos — F1 XF · F1 XF Comandante · EVOGUARD · F1 EVO', desc: 'El F1 XF y el F1 XF Comandante cumplen EN 443 y EN 14458. Consulta el certificado del modelo para EVOGUARD y F1 EVO.', tech: 'Fibra de vidrio termoendurecida · Visor Optrel retráctil · Fas-Trac III 8 puntos' },
    { tipo: 'proximidad', badge: 'Consulta norma por modelo', titulo: 'Línea Proximidad ARFF', modelos: '1 modelo — F1 XF ARFF', desc: 'Cubierta aluminizada reflectante y visor dorado para aproximación a fuegos de combustible. Consulta la norma aplicable en el certificado del modelo.', tech: 'Fibra de vidrio + aluminizado · Visor dorado reflectante · Ventilación sellable' },
    { tipo: 'forestal', badge: 'Consulta norma por modelo', titulo: 'Línea Forestal / Interfaz', modelos: '2 modelos — F1 SF · F1 SF Pro', desc: 'Cascos ligeros y ventilados para incendio de vegetación e interfaz urbano-forestal. Consulta la norma aplicable en el certificado de cada modelo.', tech: 'Termoplástico / ABS reforzado · Visor + capucha · S-130/S-190' },
  ...
  anatomia: [
    ...
    { t: 'Protección nucal articulada', d: 'Cubrenuca rígido articulado certificado consulta la norma aplicable que protege la zona cervical de brasas y escurrimientos sin limitar el movimiento de cabeza.' },
  ...
  comparativa: [
    { modelo: 'F1 XF', tipo: 'estructural', norma: 'EN 443 y EN 14458', material: 'Fibra de vidrio termoendurecida', proteccion: 'Visor Optrel retráctil', peso: '—', ideal: 'Cuerpos metropolitanos tier-1', rec: true },
    { modelo: 'F1 XF Comandante', tipo: 'mando', norma: 'EN 443 y EN 14458', material: 'Fibra de vidrio', proteccion: 'Visor dorado/plateado', peso: '—', ideal: 'Oficiales y jefes de sector', rec: false },
    { modelo: 'EVOGUARD', tipo: 'estructural', norma: '—', material: 'Composite fibra/aramida', proteccion: 'Visor Optrel retráctil', peso: '—', ideal: 'Integración nativa con MSA G1', rec: false },
    { modelo: 'F1 EVO', tipo: 'estructural', norma: '—', material: 'Polipropileno reforzado', proteccion: 'Visor facial abatible', peso: '—', ideal: 'Licitaciones municipales', rec: false },
    { modelo: 'F1 XF ARFF', tipo: 'proximidad', norma: '—', material: 'Fibra de vidrio + aluminizado', proteccion: 'Visor dorado reflectante', peso: '—', ideal: 'Aeropuertos ARFF y combustibles', rec: false },
    { modelo: 'F2 X-TREM', tipo: 'usar', norma: 'EN 16471/16473', material: 'Polipropileno alta resistencia', proteccion: 'Visor transparente retráctil', peso: '—', ideal: 'Rescate técnico y espacios confinados', rec: false },
    { modelo: 'F1 SF', tipo: 'forestal', norma: '—', material: 'Termoplástico de alta resistencia', proteccion: 'Pantalla facial abatible', peso: '—', ideal: 'Incendio vegetal e interfaz', rec: false },
    { modelo: 'F1 SF Pro', tipo: 'forestal', norma: '—', material: 'ABS reforzado + capucha', proteccion: 'Visor retráctil + capucha', peso: '—', ideal: 'Brigadas forestales alto rendimiento', rec: false },
  ],
  comparativaNote: 'Consulta la norma aplicable en el certificado de cada modelo; F1 XF y F1 XF Comandante cumplen EN 443 y EN 14458; F2 X-TREM mantiene EN 16471/16473.',
  guia: [
    ...
    { n: '02', t: 'Elige el nivel: el F1 XF lidera licitaciones tier-1; el EVOGUARD prioriza ergonomía e integración nativa con MSA G1; el F1 EVO es la entrada para presupuestos municipales sin perder la certificación consulta la norma aplicable.' },
  ...
  segmentos: [
    { num: '01', tipo: 'estructural', titulo: 'Departamentos Metropolitanos Tier-1', desc: 'CDMX, GDL, MTY, PUE y los principales cuerpos del país. El F1 XF domina por su visor retráctil, perfil bajo y trazabilidad las instrucciones del fabricante; el F1 XF Comandante identifica jerarquía con visor dorado o plateado.', modelos: 'F1 XF · F1 XF Comandante · EVOGUARD' },
    { num: '02', tipo: 'proximidad', titulo: 'Aeropuertos ARFF e Industria', desc: 'AICM, GDL, MTY y aeropuertos regionales, refinerías y procesos calientes. El F1 XF ARFF cumple consulta la norma aplicable Proximity con cubierta aluminizada y visor dorado para aproximación a fuegos de combustible.', modelos: 'F1 XF ARFF' },
    { num: '03', tipo: 'forestal', titulo: 'Brigadas Forestales / Protección Civil', desc: 'CONAFOR, brigadas de interfaz urbano-forestal y Protección Civil. El F1 SF y el F1 SF Pro cumplen consulta la norma aplicable con bajo peso, alta ventilación y compatibilidad con goggles y capucha forestal.', modelos: 'F1 SF · F1 SF Pro' },
  ...
  faqs: [
    ...
    { q: '¿Qué diferencia hay entre el F1 XF estructural, el F1 XF ARFF y el F2 X-TREM USAR?', a: 'El F1 XF estructural está certificado consulta la norma aplicable para combate en edificios. El F1 XF ARFF añade cubierta aluminizada reflectante y visor dorado consulta la norma aplicable Proximity (cap. 5–9) para aproximación a fuegos de kerosene en aeropuertos y refinerías. El F2 X-TREM es un casco de rescate técnico certificado EN 16471/16473, con diseño compacto para espacios confinados y máxima resistencia al impacto lateral en colapsos y maniobras USAR. Mismo ADN Gallet, tres escenarios de riesgo distintos.' },
...
const bullard: CascoBrand = {
  ...
  comparativa: [
    ...
    { modelo: 'USTERM', tipo: 'estructural', norma: 'NFPA 1970', material: 'Compuesto termoendurecido USTERM', proteccion: 'Visor + ocular integrado', peso: '—', ideal: 'Calor radiante alto · montaje TIC', rec: false },
    { modelo: 'XTF Composite', tipo: 'estructural', norma: 'NFPA 1970', material: 'Composite termoendurecido', proteccion: 'Visor Optrel retráctil', peso: '—', ideal: 'Metropolitano · visor retráctil', rec: false },
    { modelo: 'FH2 Commander', tipo: 'mando', norma: 'NFPA 1970', material: 'Composite ABS dorado/plateado', proteccion: 'Protector facial abatible', peso: '—', ideal: 'Oficiales y jefes de sector', rec: false },
    { modelo: '891V Classic', tipo: 'estructural', norma: 'NFPA 1970', material: 'Fibra de vidrio tradicional', proteccion: 'Visor metálico abatible', peso: '—', ideal: 'Tradición Bullard · calor radiante', rec: false },
    { modelo: 'LTX Traditional', tipo: 'estructural', norma: 'NFPA 1970', material: 'Composite estética cuero', proteccion: 'Pantalla facial abatible', peso: '—', ideal: 'Look de cuero · menor peso', rec: false },
    { modelo: 'USRRG', tipo: 'usar', norma: 'NFPA 1970', material: 'ABS de alto impacto', proteccion: 'Visor abatible + goggles', peso: '—', ideal: 'Rescate técnico · espacios confinados', rec: false },
    { modelo: 'SX6 Wildland', tipo: 'forestal', norma: 'NFPA 1950', material: 'ABS ligero ventilado', proteccion: 'Malla facial FR', peso: '—', ideal: 'Incendio vegetal e interfaz', rec: false },
  ],
  comparativaNote:
  ...
  segmentos: [
    ...
    { num: '03', tipo: 'forestal', titulo: 'Brigadas Forestales / Protección Civil', desc: 'CONAFOR, brigadas de interfaz urbano-forestal y Protección Civil. El SX6 Wildland cumple NFPA 1950 con peso conforme a la ficha técnica, ventilación activa y compatibilidad con capucha forestal.', modelos: 'SX6 Wildland' },
  ...
  faqs: [
    ...
    { q: '¿Es cierto que los cascos Bullard tienen la mejor integración con cámara térmica?', a: 'Verifica la compatibilidad entre el casco, la cámara térmica y el SCBA en las fichas técnicas de los modelos involucrados.' },
...
const cairns: CascoBrand = {
  ...
  seoDescription:
    'Cascos Cairns certificados NFPA en México: N6A Houston de cuero, 1010/1044 composite, 880 mando, 795 ARFF y forestal. Marca de cascos fundada en 1836 · distribuidor autorizado MX.',
  founding: '1836',
  parentOrg: { name: 'MSA Safety Incorporated', ticker: 'NYSE:MSA' },
  stats: [
  ...
  comparativa: [
    ...
    { modelo: '1010 Composite', tipo: 'estructural', norma: 'NFPA 1970', material: 'Composite PP + fibra de vidrio', proteccion: 'Visor facial retráctil', peso: '—', ideal: 'ADN Cairns · composite ligero', rec: false },
    { modelo: '1044 Invader', tipo: 'estructural', norma: 'NFPA 1970', material: 'Composite PP + aramida', proteccion: 'Visor retráctil integrado', peso: '—', ideal: 'Metropolitano · perfil bajo', rec: false },
    ...
    { modelo: '990 Composite', tipo: 'estructural', norma: 'NFPA 1970', material: 'Composite PP / fibra de vidrio', proteccion: 'Visor retráctil interno', peso: '—', ideal: 'Presupuesto medio · visor retráctil', rec: false },
    { modelo: '880 Commander', tipo: 'mando', norma: 'NFPA 1970', material: 'Cuero premium dorado/plateado', proteccion: 'Visor metálico de mando', peso: '—', ideal: 'Oficiales y jefes de sector', rec: false },
    { modelo: '795 ARFF', tipo: 'proximidad', norma: 'NFPA 1970', material: 'Fibra de vidrio aluminizada', proteccion: 'Visor dorado reflectante', peso: '—', ideal: 'Aeropuertos ARFF y combustibles', rec: false },
  ...
  segmentos: [
    ...
    { num: '04', tipo: 'forestal', titulo: 'Brigadas Forestales / Protección Civil', desc: 'CONAFOR, brigadas de interfaz urbano-forestal y Protección Civil. El Cairns Wildland cumple NFPA 1950 con peso conforme a la ficha técnica, ventilación activa y compatibilidad con capucha forestal.', modelos: 'Cairns Wildland' },
  ],
  faqs: [
