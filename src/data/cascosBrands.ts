...
const msaGallet: CascoBrand = {
  ...
  comparativaNote:
    '* Cascos estructurales certificados NFPA 1970; proximidad NFPA 1970 (cap. 5–9); forestal NFPA 1950; USAR EN 16471/16473. Pesos aproximados según configuración.',
  guia: [
  ...
  faqs: [
    ...
    { q: '¿Qué diferencia hay entre el F1 XF estructural, el F1 XF ARFF y el F2 X-TREM USAR?', a: 'El F1 XF estructural está certificado NFPA 1970 para combate en edificios. El F1 XF ARFF añade cubierta aluminizada reflectante y visor dorado NFPA 1970 Proximity (cap. 5–9) para aproximación a fuegos de kerosene en aeropuertos y refinerías. El F2 X-TREM es un casco de rescate técnico certificado EN 16471/16473, con diseño compacto para espacios confinados y máxima resistencia al impacto lateral en colapsos y maniobras USAR. Mismo ADN Gallet, tres escenarios de riesgo distintos.' },
