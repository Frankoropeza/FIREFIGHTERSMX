...
const bullard: CascoBrand = {
  ...
  credenciales: [
    ...
    { n: '04', t: 'Trazabilidad y disponibilidad por confirmar', d: 'Cada casco incluye número de serie verificable y documentación lista para NFPA 1850 y licitación. Confirma con cada empresa registrada la disponibilidad de los modelos demandados y la configuración del conjunto casco-SCBA-cámara.' },
  ],
  linesIntro:
