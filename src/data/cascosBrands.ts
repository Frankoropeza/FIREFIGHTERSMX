...
const msaGallet: CascoBrand = {
  ...
  heroIntro: [
    ...
    'El F1 XF es el casco más solicitado en cuerpos metropolitanos y ARFF de México. La gama cubre los cuatro escenarios de riesgo: estructural (NFPA 1970), proximidad (NFPA 1971), forestal (NFPA 1977) y rescate técnico USAR (EN 16471/16473).',
  ],
  heroBadges: ['NFPA 1970', 'NFPA 1971', 'NFPA 1977', 'Fibra de vidrio', 'Optrel retráctil', 'MSA Safety · NYSE', 'Distribuidor autorizado MX'],
  ...
  lineas: [
    ...
    { tipo: 'proximidad', badge: 'NFPA 1971 Proximity', titulo: 'Línea Proximidad ARFF', modelos: '1 modelo — F1 XF ARFF', desc: 'Cubierta aluminizada reflectante y visor dorado NFPA 1971 para aproximación a fuegos de combustible. Referencia en aeropuertos ARFF (AICM, GDL, MTY), refinerías y procesos calientes bajo normativa AFAC.', tech: 'Fibra de vidrio + aluminizado · Visor dorado reflectante · Ventilación sellable · NFPA 1971' },
    { tipo: 'forestal', badge: 'NFPA 1977', titulo: 'Línea Forestal / Interfaz', modelos: '2 modelos — F1 SF · F1 SF Pro', desc: 'Cascos ligeros y ventilados para incendio de vegetación e interfaz urbano-forestal. El F1 SF Pro incluye visor facial retráctil y capucha forestal de serie para brigadas de alto rendimiento en jornadas largas.', tech: 'Termoplástico / ABS reforzado · ~0.58–0.65 kg · Visor + capucha · NFPA 1977 · S-130/S-190' },
  ...
  comparativa: [
    ...
    { modelo: 'EVOGUARD', tipo: 'estructural', norma: 'NFPA 1971', material: 'Composite fibra/aramida', proteccion: 'Visor Optrel retráctil', peso: '~1.30 kg', ideal: 'Integración nativa con MSA G1', rec: false },
    ...
    { modelo: 'F1 XF ARFF', tipo: 'proximidad', norma: 'NFPA 1971', material: 'Fibra de vidrio + aluminizado', proteccion: 'Visor dorado reflectante', peso: '~1.55 kg', ideal: 'Aeropuertos ARFF y combustibles', rec: false },
    ...
    { modelo: 'F1 SF', tipo: 'forestal', norma: 'NFPA 1977', material: 'Termoplástico de alta resistencia', proteccion: 'Pantalla facial abatible', peso: '~0.58 kg', ideal: 'Incendio vegetal e interfaz', rec: false },
    { modelo: 'F1 SF Pro', tipo: 'forestal', norma: 'NFPA 1977', material: 'ABS reforzado + capucha', proteccion: 'Visor retráctil + capucha', peso: '~0.65 kg', ideal: 'Brigadas forestales alto rendimiento', rec: false },
  ],
  comparativaNote:
    '* Cascos estructurales certificados NFPA 1970; proximidad NFPA 1971; forestal NFPA 1977; USAR EN 16471/16473. Pesos aproximados según configuración.',
  guia: [
  ...
  segmentos: [
    ...
    { num: '02', tipo: 'proximidad', titulo: 'Aeropuertos ARFF e Industria', desc: 'AICM, GDL, MTY y aeropuertos regionales, refinerías y procesos calientes. El F1 XF ARFF cumple NFPA 1971 Proximity con cubierta aluminizada y visor dorado para aproximación a fuegos de combustible.', modelos: 'F1 XF ARFF' },
    { num: '03', tipo: 'forestal', titulo: 'Brigadas Forestales / Protección Civil', desc: 'CONAFOR, brigadas de interfaz urbano-forestal y Protección Civil. El F1 SF y el F1 SF Pro cumplen NFPA 1977 con bajo peso, alta ventilación y compatibilidad con goggles y capucha forestal.', modelos: 'F1 SF · F1 SF Pro' },
...
const bullard: CascoBrand = {
  ...
  heroBadges: ['NFPA 1970', 'NFPA 1971', 'NFPA 1977', 'Composite ABS / USTERM', 'Ala completa', 'Escudo frontal', 'TIC Mount', 'Distribuidor autorizado MX'],
  ...
  lineas: [
    { tipo: 'estructural', badge: 'NFPA 1970 · 1971', titulo: 'Línea Estructural — Ala Completa', modelos: '5 modelos — USTM · USTERM · XTF · 891V · LTX', desc: 'El estilo americano de ala completa para combate estructural. Desde el USTM —el casco de referencia— y el USTERM con montaje TIC, hasta el XTF con visor retráctil, el 891V clásico en fibra de vidrio y el LTX con estética de cuero.', tech: 'Composite ABS / USTERM termoendurecido / fibra de vidrio · Escudo frontal · Ratchet · QuadRange™' },
    { tipo: 'mando', badge: 'NFPA 1971', titulo: 'Línea de Mando', modelos: '1 modelo — FH2 Commander', desc: 'Casco de mando para oficiales. Acabado dorado (jefe de sector) o plateado (comandante) de serie, con escudo frontal personalizable con rango y emblema. Identificación visual inmediata de jerarquía en escena.', tech: 'Composite ABS dorado/plateado · Escudo de rango · QuadRange™ · NFPA 1971' },
    { tipo: 'forestal', badge: 'NFPA 1977', titulo: 'Línea Forestal / Interfaz', modelos: '1 modelo — SX6 Wildland', desc: 'El casco más ligero de la línea Bullard (~0.52 kg) para incendio de vegetación e interfaz urbano-forestal. Ventilación activa frontal y posterior, malla facial FR y compatibilidad con capucha forestal certificada.', tech: 'ABS ligero ventilado · Malla facial FR · ~0.52 kg · NFPA 1977 · S-130/S-190' },
    { tipo: 'usar', badge: 'NFPA 1971', titulo: 'Línea Rescate Técnico / USAR', modelos: '1 modelo — USRRG', desc: 'Casco de rescate urbano y operaciones técnicas. Shell ABS de alto impacto, ala corta delantera para espacios confinados y montaje frontal para linterna de 1000+ lúmenes. Suspensión QuadRange™ de 4 posiciones.', tech: 'ABS alto impacto · Ala corta · Montaje linterna 1000+ lm · QuadRange™ 4 posiciones' },
  ],
  flagship: 'USTM',
  anatomiaIntro:
  ...
  comparativa: [
    ...
    { modelo: 'XTF Composite', tipo: 'estructural', norma: 'NFPA 1971', material: 'Composite termoendurecido', proteccion: 'Visor Optrel retráctil', peso: '~1.42 kg', ideal: 'Metropolitano · visor retráctil', rec: false },
    { modelo: 'FH2 Commander', tipo: 'mando', norma: 'NFPA 1971', material: 'Composite ABS dorado/plateado', proteccion: 'Protector facial abatible', peso: '~1.50 kg', ideal: 'Oficiales y jefes de sector', rec: false },
    { modelo: '891V Classic', tipo: 'estructural', norma: 'NFPA 1971', material: 'Fibra de vidrio tradicional', proteccion: 'Visor metálico abatible', peso: '~1.65 kg', ideal: 'Tradición Bullard · calor radiante', rec: false },
    { modelo: 'LTX Traditional', tipo: 'estructural', norma: 'NFPA 1971', material: 'Composite estética cuero', proteccion: 'Pantalla facial abatible', peso: '~1.48 kg', ideal: 'Look de cuero · menor peso', rec: false },
    { modelo: 'USRRG', tipo: 'usar', norma: 'NFPA 1971', material: 'ABS de alto impacto', proteccion: 'Visor abatible + goggles', peso: '~1.40 kg', ideal: 'Rescate técnico · espacios confinados', rec: false },
    { modelo: 'SX6 Wildland', tipo: 'forestal', norma: 'NFPA 1977', material: 'ABS ligero ventilado', proteccion: 'Malla facial FR', peso: '~0.52 kg', ideal: 'Incendio vegetal e interfaz', rec: false },
  ],
  comparativaNote:
    '* Cascos estructurales y de mando certificados NFPA 1970/1971; forestal NFPA 1977. Pesos aproximados según configuración.',
  guia: [
  ...
  segmentos: [
    ...
    { num: '03', tipo: 'forestal', titulo: 'Brigadas Forestales / Protección Civil', desc: 'CONAFOR, brigadas de interfaz urbano-forestal y Protección Civil. El SX6 Wildland cumple NFPA 1977 con el menor peso de la línea, ventilación activa y compatibilidad con capucha forestal.', modelos: 'SX6 Wildland' },
...
const cairns: CascoBrand = {
  ...
  heroBadges: ['NFPA 1970', 'NFPA 1971', 'NFPA 1977', 'Cuero / Composite', 'N6A Houston', 'Escudo frontal', 'Desde 1836', 'MSA Safety'],
  ...
  lineas: [
    { tipo: 'estructural', badge: 'NFPA 1970 · 1971', titulo: 'Línea Estructural — Cuero & Composite', modelos: '5 modelos — N6A Houston · 1010 · 1044 Invader · 660C · 990', desc: 'El corazón de Cairns: del N6A Houston en cuero —el icono del servicio— al 1044 Invader composite de perfil bajo, pasando por el 660C clásico en fibra de vidrio y el 990 de presupuesto medio. Tradición y tecnología, mismo estándar NFPA.', tech: 'Cuero curtido · Composite PP/aramida · Fibra de vidrio · Visor retráctil · Escudo frontal' },
    { tipo: 'proximidad', badge: 'NFPA 1971 Proximity', titulo: 'Línea Proximidad ARFF', modelos: '1 modelo — 795 ARFF', desc: 'Casco aluminizado con visor dorado reflectante para aproximación a fuegos de combustible de aviación. Diseñado para vehículos ARFF Oshkosh, Rosenbauer y Striker, con alta retención en maniobras de alta velocidad. NFPA 1971 Proximity.', tech: 'Fibra de vidrio aluminizada · Visor dorado reflectante · Alta retención 8 puntos · NFPA 1971' },
    { tipo: 'forestal', badge: 'NFPA 1977', titulo: 'Línea Forestal / Interfaz', modelos: '1 modelo — Cairns Wildland', desc: 'Casco ultraligero (~0.55 kg) para incendio de vegetación e interfaz urbano-forestal. Ventilación activa, malla facial FR y compatibilidad con capucha forestal y goggles certificados, para jornadas de más de 8 horas.', tech: 'ABS ligero ventilado · Malla facial FR · ~0.55 kg · NFPA 1977 · S-130/S-190' },
    { tipo: 'mando', badge: 'NFPA 1971', titulo: 'Línea de Mando', modelos: '1 modelo — 880 Commander', desc: 'El casco de mando más reconocido de América del Norte: cuero premium en dorado (jefe de sector) o plateado (comandante), con suspensión Boston Leather y escudo de rango. Distinción y resistencia al calor radiante.', tech: 'Cuero premium · Visor metálico dorado/plateado · Suspensión Boston Leather · NFPA 1971' },
  ],
  ...
  comparativa: [
    ...
    { modelo: '1044 Invader', tipo: 'estructural', norma: 'NFPA 1971', material: 'Composite PP + aramida', proteccion: 'Visor retráctil integrado', peso: '~1.45 kg', ideal: 'Metropolitano · perfil bajo', rec: false },
    { modelo: '660C Traditional', tipo: 'estructural', norma: 'NFPA 1971', material: 'Fibra de vidrio + PP', proteccion: 'Pantalla facial abatible', peso: '~1.68 kg', ideal: 'Estética clásica · calor radiante', rec: false },
    { modelo: '990 Composite', tipo: 'estructural', norma: 'NFPA 1971', material: 'Composite PP / fibra de vidrio', proteccion: 'Visor retráctil interno', peso: '~1.55 kg', ideal: 'Presupuesto medio · visor retráctil', rec: false },
    { modelo: '880 Commander', tipo: 'mando', norma: 'NFPA 1971', material: 'Cuero premium dorado/plateado', proteccion: 'Visor metálico de mando', peso: '~1.85 kg', ideal: 'Oficiales y jefes de sector', rec: false },
    { modelo: '795 ARFF', tipo: 'proximidad', norma: 'NFPA 1971', material: 'Fibra de vidrio aluminizada', proteccion: 'Visor dorado reflectante', peso: '~1.70 kg', ideal: 'Aeropuertos ARFF y combustibles', rec: false },
    { modelo: 'Wildland', tipo: 'forestal', norma: 'NFPA 1977', material: 'ABS ligero ventilado', proteccion: 'Malla FR abatible', peso: '~0.55 kg', ideal: 'Incendio vegetal e interfaz', rec: false },
  ],
  comparativaNote:
    '* Cascos estructurales y de mando certificados NFPA 1970/1971; proximidad NFPA 1971; forestal NFPA 1977. Pesos aproximados según configuración.',
  guia: [
  ...
  segmentos: [
    ...
    { num: '03', tipo: 'proximidad', titulo: 'Aeropuertos ARFF e Industria', desc: 'AICM, GDL, MTY y aeropuertos regionales, refinerías y procesos calientes. El 795 ARFF cumple NFPA 1971 Proximity con cubierta aluminizada y visor dorado para aproximación a fuegos de combustible.', modelos: '795 ARFF' },
    { num: '04', tipo: 'forestal', titulo: 'Brigadas Forestales / Protección Civil', desc: 'CONAFOR, brigadas de interfaz urbano-forestal y Protección Civil. El Cairns Wildland cumple NFPA 1977 con el menor peso de la línea, ventilación activa y compatibilidad con capucha forestal.', modelos: 'Cairns Wildland' },
  ],
  faqs: [
    ...
    { q: '¿El casco de cuero cumple la misma certificación NFPA que el composite?', a: 'Sí. Tanto el N6A Houston de cuero como los modelos composite y de fibra de vidrio están certificados por laboratorio acreditado bajo NFPA 1970 (estructural) o NFPA 1977 (forestal), con número de serie verificable con fábrica. El material cambia el peso, la estética y el mantenimiento, no el nivel de protección exigido por la norma. El cuero requiere un cuidado específico (acondicionado periódico) que documentamos en la guía de la marca.' },
