...
const globe: EquipmentBrand = {
  ...
  heroBadges: ['NFPA 1970', 'NFPA 1950', 'PBI Matrix', 'GORE-TEX CrossTech', 'MSA Safety', '110+ años', 'Distribuidor autorizado MX'],
  ...
  lineas: [
    { tipo: 'estructural', badge: 'NFPA 1970', titulo: 'Línea Estructural', modelos: '4 modelos — G-XTREME 3.0 · ATHLETIX · CLASSIX · G-XCEL', desc: 'La gama estructural reúne opciones para distintos escenarios operativos. Desde el modelo más licitado en tier-1 (G-XTREME 3.0 con GORE-TEX CrossTech® PFAS-free) hasta la entrada más competitiva en licitaciones municipales (G-XCEL).', tech: 'PBI Matrix · Nomex NXT · GORE-TEX CrossTech® PFAS-free · Nomex IIIA' },
    ...
    { tipo: 'forestal', badge: 'NFPA 1950', titulo: 'Línea Forestal / Interfaz', modelos: '1 modelo — Warrior Wildland', desc: 'Para brigadas forestales y de interfaz urbano-forestal. Consulta los valores THL del certificado del modelo para máxima respirabilidad en operaciones prolongadas. Compatible con los estándares CONAFOR S-130/S-190.', tech: 'Nomex/Kevlar blend · valores THL del certificado del modelo · NFPA 1950 · S-130/S-190' },
  ],
  ...
  comparativa: [
    { modelo: 'G-XTREME 3.0', tipo: 'estructural', shell: 'PBI Matrix', tpp: '—', thl: '—', peso: '—', ideal: 'Licitaciones tier-1, uso intensivo', rec: true },
    { modelo: 'ATHLETIX', tipo: 'estructural', shell: 'PBI/Kevlar Kombat', tpp: '—', thl: '—', peso: '—', ideal: 'Rescate técnico, alta movilidad', rec: false },
    { modelo: 'CLASSIX', tipo: 'estructural', shell: 'Nomex NXT', tpp: '—', thl: '—', peso: '—', ideal: 'Servicio estándar, alta rotación', rec: false },
    { modelo: 'G-XCEL', tipo: 'estructural', shell: 'Nomex IIIA', tpp: '—', thl: '—', peso: '—', ideal: 'Presupuesto estatal ajustado', rec: false },
    { modelo: 'Proximity ARFF', tipo: 'proximidad', shell: 'Aluminizado 3 capas', tpp: '—', thl: '—', peso: '—', ideal: 'Aeropuertos ARFF, refinerías', rec: false },
    { modelo: 'Warrior Wildland', tipo: 'forestal', shell: 'Nomex/Kevlar blend', tpp: '—', thl: '—', peso: '—', ideal: 'Interfaz urbano-forestal, PC', rec: false },
  ],
...
const lion: EquipmentBrand = {
  ...
  crossDesc: 'V-Force® movilidad · Quantum · Sede en Dayton, Ohio · NFPA 1970+1977',
  ...
  heroBadges: ['NFPA 1970', 'NFPA 1950', 'PBI Matrix', 'V-Force®', 'Kombat Stretch', 'Sede en Dayton, Ohio', 'Distribuidor autorizado MX'],
  ...
  comparativa: [
    { modelo: 'Quantum', tipo: 'estructural', shell: 'PBI Matrix', tpp: '—', thl: '—', peso: '—', ideal: 'Tier-1, alto riesgo, uso intensivo', rec: true },
    { modelo: 'Alpha', tipo: 'estructural', shell: 'Nomex NXT', tpp: '—', thl: '—', peso: '—', ideal: 'Municipal estándar, licitación base', rec: false },
    { modelo: 'Stealth', tipo: 'estructural', shell: 'Kombat Stretch', tpp: '—', thl: '—', peso: '—', ideal: 'Rescate técnico, alta movilidad', rec: false },
    { modelo: 'Commander', tipo: 'estructural', shell: 'Nomex IIIA', tpp: '—', thl: '—', peso: '—', ideal: 'Alta rotación, presupuesto ajustado', rec: false },
    { modelo: 'ARFF Proximity', tipo: 'proximidad', shell: 'Aluminizado 3 capas', tpp: '—', thl: '—', peso: '—', ideal: 'Aeropuertos ARFF, AICM, NAIM', rec: false },
    { modelo: 'Interface Wildland', tipo: 'forestal', shell: 'Nomex/Kevlar blend', tpp: '—', thl: '—', peso: '—', ideal: 'CONAFOR, PC estatal, interfaz forestal', rec: false },
  ],
  comparativaNote: NOTA_TPP_THL,
  guia: [
  ...
  segmentos: [
    ...
    { num: '04', tipo: 'forestal', titulo: 'Protección Civil / Forestal', desc: 'El Interface Wildland NFPA 1950 cubre el escenario de interfaz urbano-forestal con bajo peso (peso conforme a ficha técnica), alta transpirabilidad valores THL del certificado del modelo y aprobación para quemas controladas y combate directo.', modelos: 'Lion Interface Wildland' },
  ],
  faqs: [
    { q: '¿Cuál es el traje Lion más recomendado para licitaciones municipales en México?', a: 'El Lion Alpha es el modelo de mayor penetración en departamentos municipales mid-tier: cumple NFPA 1970 con shell Nomex NXT, valores THL del certificado del modelo y precio competitivo para presupuestos estatales. Para departamentos tier-1 (CDMX, GDL, MTY, Pemex) el Lion Quantum con PBI Matrix eleva el TPP y extiende la vida útil bajo uso intensivo. Asesoramos el modelo correcto según el escenario de riesgo y el pliego de condiciones de cada licitación.' },
    ...
    { q: '¿En qué se diferencia el Lion Quantum del Globe G-XTREME 3.0?', a: 'Ambos son trajes estructurales premium NFPA 1970 con shell PBI Matrix. La diferencia principal está en la movilidad: el Quantum usa V-Force® (preformado ergonómico) versus el G-XTREME 3.0 que prioriza la construcción de capas y la barrera GORE-TEX CrossTech®. En términos de protección térmica los dos superan ampliamente los mínimos NFPA 1970 (TPP ≥ 35, valores THL del certificado). La elección suele depender de la preferencia operacional del cuerpo: mayor movilidad (Lion) o barrera de humedad premium PFAS-free (Globe). Podemos facilitarte ambas fichas técnicas para evaluación comparativa.' },
...
const honeywell: EquipmentBrand = {
  ...
  heroBadges: ['NFPA 1970', 'NFPA 2112', 'NFPA 1990', 'ICAO Annex 14', 'PBI Gold', 'CarbonX®', 'BioClad® CBRN', 'Distribuidor autorizado MX'],
  ...
  credenciales: [
    { n: '01', t: 'Honeywell International', d: 'Morning Pride es la línea de EPP para bomberos de Honeywell International — un conglomerado industrial internacional con presencia en más de 100 países. Su espalda tecnológica y financiera garantiza continuidad de suministro, certificaciones vigentes e I+D constante.' },
  ...
  comparativa: [
    { modelo: 'TechGen', tipo: 'estructural', shell: 'PBI Gold', tpp: '—', thl: '—', peso: '—', ideal: 'Pemex, petroquímica, brigadas tier-1', rec: true },
    { modelo: 'HP Series', tipo: 'estructural', shell: 'Nomex NXT', tpp: '—', thl: '—', peso: '—', ideal: 'Municipal tier-1, alta rotación', rec: false },
    { modelo: 'GenII', tipo: 'estructural', shell: 'Nomex IIIA', tpp: '—', thl: '—', peso: '—', ideal: 'Presupuesto estatal, entrada NFPA', rec: false },
    { modelo: 'ARFF Proximity', tipo: 'proximidad', shell: 'Aluminizado 3 capas', tpp: '—', thl: '—', peso: '—', ideal: 'Aeropuertos ARFF, AICM, NAIM', rec: false },
    { modelo: 'BioClad CBRN', tipo: 'cbrn', shell: 'PBI + barrera química', tpp: '—', thl: '—', peso: '—', ideal: 'HAZMAT, respuesta química, PC', rec: false },
    { modelo: 'CarbonX Proximity', tipo: 'industrial', shell: 'CarbonX®', tpp: '—', thl: '—', peso: '—', ideal: 'Refinerías, offshore, CENAGAS', rec: false },
  ],
  comparativaNote: NOTA_TPP_THL,
  guia: [
...
const fireDex: EquipmentBrand = {
  ...
  brand: 'Fire-Dex',
  brandLabel: 'Fire-Dex',
  crossDesc: 'TECGEN® · de peso reducido · PFAS-free nativo · Tecnología TECGEN®',
  ...
  heroIntro: [
    'Fire-Dex es la marca de presencia en licitaciones en licitaciones tier-1 de México (2023-2025). No por inercia institucional — sino porque sus especificaciones técnicas ganan en comparativa directa: THL documentado que Nomex NXT, menor peso que PBI Matrix, PFAS-free nativo en toda la línea TECGEN® y precio de adquisición más competitivo.',
  ...
  heroBadges: ['NFPA 1970', 'NFPA 2112', 'TECGEN® 71', 'TECGEN® 51', 'PBI/TECGEN Hybrid', 'PFAS-free', 'Distribuidor autorizado MX'],
  seoTitle: 'Trajes Fire-Dex NFPA 1970 — TECGEN® · México',
  seoDescription:
    'Catálogo completo Fire-Dex certificados NFPA 1970 en México. TECGEN71, TECGEN51 (de peso reducido), H71 Hybrid, FXR Proximity y Kombat. La marca de presencia en licitaciones en licitaciones tier-1 MX 2023-2025. Distribuidor autorizado · stock CDMX.',
  stats: [
  ...
  comparativa: [
    { modelo: 'TECGEN71', tipo: 'estructural', shell: 'TECGEN® 71', tpp: '—', thl: '—', peso: '—', ideal: 'Licitaciones tier-1, alto rendimiento', rec: true },
    { modelo: 'TECGEN51', tipo: 'estructural', shell: 'TECGEN® 51', tpp: '—', thl: '—', peso: '—', ideal: 'Máxima ligereza, climas cálidos', rec: false },
    { modelo: 'H71 Hybrid', tipo: 'estructural', shell: 'PBI/TECGEN® blend', tpp: '—', thl: '—', peso: '—', ideal: 'Premium, alta frecuencia operacional', rec: false },
    { modelo: 'Kombat', tipo: 'estructural', shell: 'TECGEN/PBI + Stretch', tpp: '—', thl: '—', peso: '—', ideal: 'Rescate técnico, SAR, movilidad max', rec: false },
    { modelo: '1971 Series', tipo: 'estructural', shell: 'Nomex IIIA', tpp: '—', thl: '—', peso: '—', ideal: 'Entrada NFPA, presupuesto ajustado', rec: false },
  ...
  guia: [
    ...
    { n: '02', t: 'Prioriza peso o tecnología: TECGEN51 (peso conforme a ficha técnica) para máxima ligereza y climas cálidos; TECGEN71 para THL documentado en servicio intensivo; H71 híbrido PBI/TECGEN para protección premium; 1971 Series Nomex IIIA para presupuesto ajustado.' },
...
const skold: EquipmentBrand = {
  ...
  lineas: [
    ...
    { tipo: 'industrial', badge: 'Equiv. NFPA 1971:1991 · excede NFPA 2113', titulo: 'Línea Defender — Brigadista industrial', familiaLabel: 'Defender', flagship: 'skold-defender-brigadista', modelos: '1 modelo, 6 colores — combo, kit y piezas sueltas', desc: 'El traje de brigada industrial de la marca. Shell Nomex IIIA con 2% de fibra antiestática, refuerzos UltraShield y una suite de normas europeas poco común en el segmento: antiestática EN 1149-3/5, químicos EN 13034, arco eléctrico IEC 61482-2 clase II y térmico ISO 11612. Disponible con o sin DRD.', tech: 'Nomex IIIA 93/5/2 · Neopreno · Chambray · 6 colores' },
  ...
  comparativa: [
    ...
    { modelo: 'Herö Nomex', tipo: 'estructural', shell: 'Nomex IIIA', tpp: '—', thl: '—', peso: '—', ideal: 'Herö de menor costo de adquisición', rec: false },
    ...
    { modelo: 'Overol de Rescate FPOR', tipo: 'usar', shell: 'Tela FR certificada NFPA 2112', tpp: '—', thl: '—', peso: '—', ideal: 'Extricación, rescate vehicular, USAR', rec: false },
  ],
