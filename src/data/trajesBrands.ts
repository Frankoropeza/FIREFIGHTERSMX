...
const NOTA_TPP_THL =
  '* TPP = Thermal Protective Performance · THL = Total Heat Loss · Valores mínimos certificados NFPA 1971 / NFPA 1977 según modelo.';
...
const globe: EquipmentBrand = {
  ...
  heroIntro: [
    ...
    'Su línea cubre los tres tipos de riesgo: trajes estructurales (NFPA 1971) para combate en edificios, traje de proximidad aluminizado para aeropuertos ARFF y refinerías, y traje forestal (NFPA 1977) para incendio de interfaz urbano-forestal.',
  ],
  heroBadges: ['NFPA 1971-2018', 'NFPA 1977', 'PBI Matrix', 'GORE-TEX CrossTech', 'MSA Safety', '110+ años', 'Distribuidor autorizado MX'],
  seoTitle: 'Trajes Globe Manufacturing NFPA 1971 — Distribuidor MX',
  seoDescription:
    'Catálogo completo de trajes Globe Manufacturing certificados NFPA 1971 en México. G-XTREME 3.0, ATHLETIX, CLASSIX, G-XCEL, Proximity ARFF y Warrior Wildland. Distribuidor autorizado con stock en CDMX.',
  founding: '1887',
  ...
  lineas: [
    { tipo: 'estructural', badge: 'NFPA 1971', titulo: 'Línea Estructural', modelos: '4 modelos — G-XTREME 3.0 · ATHLETIX · CLASSIX · G-XCEL', desc: 'La gama estructural más completa del mercado mexicano. Desde el modelo más licitado en tier-1 (G-XTREME 3.0 con GORE-TEX CrossTech® PFAS-free) hasta la entrada más competitiva en licitaciones municipales (G-XCEL).', tech: 'PBI Matrix · Nomex NXT · GORE-TEX CrossTech® PFAS-free · Nomex IIIA' },
    { tipo: 'proximidad', badge: 'NFPA 1971 Proximity + ICAO', titulo: 'Línea Proximity ARFF', modelos: '1 modelo — Globe Proximity ARFF', desc: 'Certificado ICAO Annex 14 para operaciones de rescate en pista. Shell aluminizado de tres capas con reflectividad >90%. Referencia en AICM, NAIM y aeropuertos regionales bajo normativa AFAC.', tech: 'Shell aluminizado 3 capas · Reflectividad >90% · ICAO Annex 14' },
    { tipo: 'forestal', badge: 'NFPA 1977', titulo: 'Línea Forestal / Interfaz', modelos: '1 modelo — Warrior Wildland', desc: 'Para brigadas forestales y de interfaz urbano-forestal. THL ≥ 200 W/m² para máxima respirabilidad en operaciones prolongadas. Compatible con los estándares CONAFOR S-130/S-190.', tech: 'Nomex/Kevlar blend · THL ≥ 200 W/m² · NFPA 1977 · S-130/S-190' },
  ],
  ...
  guia: [
    { n: '01', t: 'Define el escenario dominante: combate estructural en edificios → línea estructural NFPA 1971; aproximación a combustible/ARFF → Proximity; incendio de vegetación → Warrior Wildland NFPA 1977. La norma correcta sale de aquí.' },
  ...
  segmentos: [
    ...
    { num: '02', tipo: 'estructural', titulo: 'Brigadas Municipales y Estatales', desc: 'Protección Civil y cuerpos municipales con presupuestos estatales. CLASSIX y G-XCEL ofrecen cumplimiento NFPA 1971 con costo de ciclo de vida optimizado para equipamiento de flotas completas.', modelos: 'CLASSIX · G-XCEL' },
    ...
    { num: '04', tipo: 'forestal', titulo: 'Brigadas Forestales / Protección Civil', desc: 'CONAFOR, brigadas de interfaz urbano-forestal y Protección Civil con riesgo de incendio. El Warrior Wildland cumple NFPA 1977 y los estándares S-130/S-190 requeridos por organismos federales.', modelos: 'Warrior Wildland' },
  ],
  faqs: [
  ...
  waQuote: 'Hola, quiero cotizar trajes Globe Manufacturing NFPA 1971.',
};
...
const lion: EquipmentBrand = {
  ...
  crossDesc: 'V-Force® movilidad · Quantum · 135+ años · NFPA 1971+1977',
  ...
  heroIntro: [
    ...
    'La línea cubre los tres escenarios de riesgo certificados por NFPA: trajes estructurales con tecnología V-Force® para máxima movilidad, traje de proximidad aluminizado para ARFF, y traje forestal NFPA 1977 para interfaz urbano-forestal.',
  ],
  heroBadges: ['NFPA 1971-2018', 'NFPA 1977', 'PBI Matrix', 'V-Force®', 'Kombat Stretch', '135+ años', 'Distribuidor autorizado MX'],
  seoTitle: 'Trajes Lion Apparel NFPA 1971 — Distribuidor México',
  seoDescription:
    'Catálogo completo Lion Apparel certificados NFPA 1971 en México. Quantum, Alpha, Stealth, Commander, ARFF Proximity e Interface Wildland NFPA 1977. Distribuidor autorizado · stock CDMX · fichas para licitación.',
  founding: '1889',
  stats: [
  ...
  credenciales: [
    ...
    { n: '04', t: 'Cobertura de riesgo completa', d: 'La línea Lion cubre los tres escenarios NFPA: estructural (NFPA 1971), proximidad ARFF (NFPA 1971 Proximity) y forestal/interfaz (NFPA 1977). Una sola relación de distribuidor para todo el catálogo de riesgos.' },
  ],
  linesIntro:
    'Lion cubre los tres escenarios de riesgo NFPA desde un solo proveedor: estructural con movilidad V-Force®, proximidad ARFF para aeropuertos y forestal NFPA 1977 para interfaz. Una sola relación de distribución para todo el catálogo de riesgos.',
  lineas: [
    { tipo: 'estructural', badge: 'NFPA 1971', titulo: 'Línea Estructural', modelos: '4 modelos — Quantum · Alpha · Stealth · Commander', desc: 'Cubre desde el traje de alta performance con PBI Matrix hasta la opción de mayor relación costo-durabilidad con Nomex IIIA. El sistema V-Force® aporta movilidad en los modelos premium.', tech: 'V-Force® · PBI Matrix · Nomex NXT · Kombat Stretch' },
    { tipo: 'proximidad', badge: 'NFPA 1971 Proximity', titulo: 'Línea ARFF Proximity', modelos: '1 modelo — ARFF Proximity', desc: 'Shell aluminizado de 3 capas con reflectividad > 90 %, diseñado para combate de incendios en aeronaves y derrames de combustible en pista. Certificado ICAO Annex 14.', tech: 'Aluminizado 3 capas · ICAO Annex 14 · Alta reflectividad' },
    { tipo: 'forestal', badge: 'NFPA 1977', titulo: 'Línea Forestal / Interfaz', modelos: '1 modelo — Interface Wildland', desc: 'Shell Nomex/Kevlar blend optimizado para incendio forestal e interfaz urbano-forestal. Mayor THL (transpirabilidad) para operaciones de larga duración en campo.', tech: 'Nomex/Kevlar blend · Alta transpirabilidad · Peso ~2.9 kg' },
  ],
  flagship: 'Quantum',
  anatomiaIntro:
  ...
  anatomia: [
    ...
    { t: 'Forro térmico', d: 'Capa interior de aislamiento que aporta el TPP certificado NFPA 1971 sin penalizar el peso ni la flexibilidad del conjunto.' },
    { t: 'Trim reflejante 3M Scotchlite', d: 'Bandas retroreflejantes y fluorescentes en configuración NFPA para visibilidad de 360° en humo, noche y baja iluminación.' },
  ...
  comparativaNote: NOTA_TPP_THL,
  guia: [
    { n: '01', t: 'Define el escenario dominante: combate estructural → línea Quantum/Alpha/Stealth/Commander; aproximación a combustible/ARFF → ARFF Proximity; incendio de vegetación → Interface Wildland NFPA 1977.' },
  ...
  segmentos: [
    { num: '01', tipo: 'estructural', titulo: 'Departamentos Metropolitanos', desc: 'Los departamentos urbanos de alta demanda eligen el Quantum y el Alpha por su balance entre protección NFPA 1971, durabilidad bajo ciclos intensivos y disponibilidad en stock para reposición inmediata.', modelos: 'Lion Quantum · Lion Alpha' },
    { num: '02', tipo: 'proximidad', titulo: 'Brigadas ARFF', desc: 'El Lion ARFF Proximity cumple NFPA 1971 Proximity e ICAO Annex 14, cubriendo los requisitos de los aeropuertos más exigentes en México para combate de incendios en aeronaves.', modelos: 'Lion ARFF Proximity' },
    ...
    { num: '04', tipo: 'forestal', titulo: 'Protección Civil / Forestal', desc: 'El Interface Wildland NFPA 1977 cubre el escenario de interfaz urbano-forestal con bajo peso (~2.9 kg), alta transpirabilidad THL ≥ 200 W/m² y aprobación para quemas controladas y combate directo.', modelos: 'Lion Interface Wildland' },
  ],
  faqs: [
    { q: '¿Cuál es el traje Lion más recomendado para licitaciones municipales en México?', a: 'El Lion Alpha es el modelo de mayor penetración en departamentos municipales mid-tier: cumple NFPA 1971 con shell Nomex NXT, THL ≥ 130 W/m² y precio competitivo para presupuestos estatales. Para departamentos tier-1 (CDMX, GDL, MTY, Pemex) el Lion Quantum con PBI Matrix eleva el TPP y extiende la vida útil bajo uso intensivo. Asesoramos el modelo correcto según el escenario de riesgo y el pliego de condiciones de cada licitación.' },
    ...
    { q: '¿En qué se diferencia el Lion Quantum del Globe G-XTREME 3.0?', a: 'Ambos son trajes estructurales premium NFPA 1971 con shell PBI Matrix. La diferencia principal está en la movilidad: el Quantum usa V-Force® (preformado ergonómico) versus el G-XTREME 3.0 que prioriza la construcción de capas y la barrera GORE-TEX CrossTech®. En términos de protección térmica los dos superan ampliamente los mínimos NFPA 1971 (TPP ≥ 35, THL ≥ 130). La elección suele depender de la preferencia operacional del cuerpo: mayor movilidad (Lion) o barrera de humedad premium PFAS-free (Globe). Podemos facilitarte ambas fichas técnicas para evaluación comparativa.' },
  ...
  waQuote: 'Hola, quiero cotizar trajes Lion Apparel NFPA 1971.',
};
...
const honeywell: EquipmentBrand = {
  ...
  heroIntro: [
    ...
    'A diferencia de otras marcas estructurales, Morning Pride cubre cuatro normas NFPA en un mismo catálogo: NFPA 1971 estructural, NFPA 2112 flash fire industrial, NFPA 1992 HAZMAT y NFPA 1971 Proximity para ARFF — más la certificación ICAO Annex 14 para aeropuertos internacionales.',
  ],
  heroBadges: ['NFPA 1971-2018', 'NFPA 2112', 'NFPA 1992', 'ICAO Annex 14', 'PBI Gold', 'CarbonX®', 'BioClad® CBRN', 'Distribuidor autorizado MX'],
  seoTitle: 'Trajes Honeywell Morning Pride NFPA 1971 — México',
  seoDescription:
    'Catálogo completo Honeywell Morning Pride certificados NFPA 1971 en México. TechGen, HP Series, GenII, ARFF Proximity, BioClad CBRN y CarbonX Proximity para Pemex, CFE y aeropuertos. Distribuidor autorizado · stock CDMX.',
  parentOrg: { name: 'Honeywell International' },
  stats: [
    { valor: '1920s', etiq: 'Origen de Morning Pride' },
    { valor: '4 normas', etiq: 'NFPA 1971 · 2112 · 1992 · ICAO' },
  ...
  lineas: [
    { tipo: 'estructural', badge: 'NFPA 1971', titulo: 'Línea Estructural', modelos: '3 modelos — TechGen · HP Series · GenII', desc: 'Trajes estructurales para combate directo de incendios en edificios e instalaciones industriales. Shell desde Nomex IIIA hasta PBI Gold según el nivel de riesgo y presupuesto.', tech: 'PBI Gold · Nomex NXT · Nomex IIIA · Suspensión de capas Honeywell' },
    { tipo: 'proximidad', badge: 'NFPA 1971 Proximity + ICAO', titulo: 'Línea ARFF Proximity', modelos: '1 modelo — ARFF Proximity', desc: 'Traje aluminizado de 3 capas para rescate aeronáutico y plantas petroquímicas. Alta reflectividad ante combustibles de alto poder calorífico. Certificado ICAO Annex 14.', tech: 'Aluminizado 3 capas · Reflectividad > 90% · ICAO Annex 14' },
    { tipo: 'industrial', badge: 'NFPA 1971 Proximity · ATEX', titulo: 'Línea Proximity Industrial', modelos: '1 modelo — CarbonX® Proximity', desc: 'Traje de proximidad con fibra CarbonX® para refinerías, plantas de proceso y plataformas offshore. Resistencia química superior a hidrocarburos y Jet-A. Referencia en Pemex y CENAGAS.', tech: 'CarbonX® · Resistencia HC+Jet-A · ATEX Zona 1/2 (opcional)' },
    { tipo: 'cbrn', badge: 'NFPA 1971 · NFPA 1992 · CBRN', titulo: 'Línea CBRN / HAZMAT', modelos: '1 modelo — BioClad® CBRN', desc: 'Traje estructural con barrera química BioClad® integrada. Protección contra agentes biológicos, vapores químicos y exposición CBRN. Compatible con descontaminación NFPA 1992 y NOM.', tech: 'BioClad® · Barrera química · Descontaminación NOM/NFPA 1992' },
  ],
  flagship: 'TechGen',
  anatomiaIntro:
  ...
  anatomia: [
    ...
    { t: 'Forro térmico', d: 'Capa interior de aislamiento que aporta el TPP certificado NFPA 1971 en combate estructural directo de larga duración.' },
    { t: 'Opción BioClad® / CarbonX®', d: 'Barrera química integrada para HAZMAT/CBRN (BioClad®) o resistencia a hidrocarburos y Jet-A (CarbonX®), sin separar al elemento de su certificación NFPA 1971.' },
  ...
  waQuote: 'Hola, quiero cotizar trajes Honeywell Morning Pride NFPA 1971.',
};
...
const fireDex: EquipmentBrand = {
  ...
  heroIntro: [
    ...
    'TECGEN® es una fibra sintética de segunda generación que supera a Nomex en transpirabilidad manteniendo el mismo nivel de protección certificado NFPA 1971. Cuando los departamentos empiezan a medir THL junto con TPP, Fire-Dex gana.',
  ],
  heroBadges: ['NFPA 1971-2018', 'NFPA 2112', 'TECGEN® 71', 'TECGEN® 51', 'PBI/TECGEN Hybrid', 'PFAS-free', 'Distribuidor autorizado MX'],
  seoTitle: 'Trajes Fire-Dex NFPA 1971 — TECGEN® · México',
  seoDescription:
    'Catálogo completo Fire-Dex certificados NFPA 1971 en México. TECGEN71, TECGEN51 (el más ligero), H71 Hybrid, FXR Proximity y Kombat. La marca de mayor crecimiento en licitaciones tier-1 MX 2023-2025. Distribuidor autorizado · stock CDMX.',
  stats: [
    { valor: '3.5 kg', etiq: 'Traje NFPA 1971 más ligero (TECGEN51)' },
  ...
  credenciales: [
    ...
    { n: '03', t: 'El traje más ligero de su clase NFPA 1971', d: 'TECGEN51 a ~3.5 kg es el traje estructural certificado NFPA 1971 más ligero disponible en el mercado mexicano. Esa diferencia frente al promedio Nomex (~4.6 kg) equivale a 1.1 kg menos de carga — un 24% de reducción que impacta directamente en la fatiga operacional.' },
  ...
  lineas: [
    { tipo: 'estructural', badge: 'NFPA 1971 · Ultra ligero', titulo: 'Línea TECGEN® Puro', modelos: '2 modelos — TECGEN71 · TECGEN51', desc: 'La línea con mejor THL del mercado y el menor peso en su clase NFPA 1971. TECGEN71 para servicio intensivo; TECGEN51 para el departamento que necesita el mínimo estrés térmico posible.', tech: 'TECGEN® 71 / 51 · THL ≥ 165 W/m² · ~3.5–3.8 kg · PFAS-free nativo' },
    { tipo: 'estructural', badge: 'NFPA 1971 · Alto rendimiento', titulo: 'Línea Híbrida', modelos: '2 modelos — H71 Hybrid · Kombat', desc: 'Lo mejor de PBI y TECGEN en una sola construcción. H71 para operaciones de alta frecuencia con protección premium; Kombat para rescate técnico con tejido Stretch en zonas articulares.', tech: 'PBI/TECGEN® blend · Kombat Stretch · THL ≥ 145–150 W/m² · ~4.0–4.1 kg' },
    { tipo: 'estructural', badge: 'NFPA 1971 · Acceso', titulo: 'Línea 1971 Clásica', modelos: '1 modelo — 1971 Series', desc: 'La puerta de entrada a la calidad Fire-Dex. Shell Nomex IIIA con certificación NFPA 1971 completa y sistema de calidad Fire-Dex. Ideal para departamentos con presupuesto estatal ajustado.', tech: 'Nomex IIIA · THL ≥ 130 W/m² · ~4.5 kg · Precio competitivo' },
    { tipo: 'industrial', badge: 'NFPA 1971 Proximity', titulo: 'Línea FXR Proximity', modelos: '1 modelo — FXR Proximity', desc: 'Traje de proximidad FXR aluminizado para supresión industrial, petroquímica y flash fire. Reflexividad > 85 % con sistema tricapa optimizado para planta química y almacenes de combustible.', tech: 'FXR aluminizado · Reflexividad > 85% · Resistencia flash fire HC' },
  ],
  flagship: 'TECGEN71',
  anatomiaIntro:
  ...
  anatomia: [
    ...
    { t: 'Forro térmico ligero', d: 'Capa interior de aislamiento optimizada para aportar el TPP certificado NFPA 1971 con el menor peso de su clase (~3.5–3.8 kg).' },
    { t: 'Trim reflejante 3M Scotchlite', d: 'Bandas retroreflejantes y fluorescentes en configuración NFPA para visibilidad de 360° en humo, noche y baja iluminación.' },
  ...
  segmentos: [
    ...
    { num: '03', tipo: 'estructural', titulo: 'Brigadas con renovación NFPA 1850', desc: 'Los departamentos que renuevan trajes por vencimiento NFPA 1850 (10 años) evalúan hoy marcas con tecnología actual. TECGEN71 ofrece mejor THL que Nomex NXT al mismo nivel NFPA 1971 — y a menor costo de adquisición que PBI Matrix.', modelos: 'TECGEN71 · 1971 Series' },
