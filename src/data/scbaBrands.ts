...
const msaG1: EquipmentBrand = {
  ...
  seoDescription:
    'SCBA MSA G1 certificado NFPA 1970 y NIOSH en México: estructural, industrial 60 min, CBRN y RIT. Cilindro de fibra de carbono 4500 psi, electrónica EOSTI integrada. Refacciones originales.',
  founding: '1914',
  ...
  credenciales: [
    ...
    { n: '03', t: 'Mantenimiento NFPA 1850', d: 'El programa que exige la norma: prueba hidrostática de cilindros, prueba de flujo anual, mantenimiento de reguladores y refacciones originales, con bitácora lista para auditoría.' },
  ...
  segmentosIntro:
    'El G1 es la primera opción de los cuerpos que requieren la electrónica más integrada, telemetría para control de aire, con el respaldo de MSA Safety y soporte en los 32 estados.',
  segmentos: [
...
const dragerPss: EquipmentBrand = {
  ...
  eyebrow: 'Dräger · PSS 7000',
  heroTitleTop: 'SCBA Dräger',
  heroTitleAccent: 'PSS 7000 NFPA.',
  heroLead:
    'Línea completa del SCBA Dräger PSS 7000 en México. Las 4 configuraciones —estructural, industrial 60 min, CBRN y RIT— con el arnés más ergonómico de su clase, electrónica Sentinel.',
  heroIntro: [
  ...
  heroBadges: ['NFPA 1970', 'EN 137', 'NIOSH', 'Arnés ergonómico', 'Sentinel', 'Ingeniería alemana'],
  seoTitle: 'SCBA Dräger PSS 7000 NFPA 1970 — Aire Autónomo MX',
  seoDescription:
    'SCBA Dräger PSS 7000 certificado NFPA 1970 y EN 137 en México: estructural, industrial 60 min, CBRN y RIT. Arnés ergonómico, electrónica Sentinel. Refacciones originales.',
  founding: '1889',
  ...
  credenciales: [
    ...
    { n: '03', t: 'Electrónica Sentinel y mantenimiento', d: 'La electrónica Sentinel integra alarma de inmovilidad, gestión de aire y telemetría opcional. El programa NFPA 1850 comprende prueba de flujo, hidrostática y refacciones originales con bitácora.' },
  ...
  faqs: [
    ...
    { q: '¿Qué mantenimiento exige un SCBA y cada cuánto?', a: 'La NFPA 1850 establece el programa: prueba de flujo al menos anual, inspección del usuario antes de cada uso, prueba hidrostática del cilindro de fibra de carbono cada 5 años (vida útil de 15 años) y mantenimiento de pulmoautomáticos según fabricante.' },
...
const scottAirPak: EquipmentBrand = {
  ...
  eyebrow: '3M Scott · Air-Pak NxG7',
  heroTitleTop: 'SCBA 3M Scott',
  heroTitleAccent: 'Air-Pak NxG7.',
  heroLead:
    'Línea completa del SCBA 3M Scott Air-Pak NxG7 en México. Las 4 configuraciones —estructural, industrial 60 min, CBRN y RIT— con plataforma modular, localizador Pak-Tracker integrado.',
  heroIntro: [
  ...
  heroBadges: ['NFPA 1970', 'NIOSH', 'Pak-Tracker', 'EPIC 3', 'Modular', '4500 psi'],
  seoTitle: 'SCBA 3M Scott Air-Pak NxG7 NFPA 1970 — México',
  seoDescription:
    'SCBA 3M Scott Air-Pak NxG7 certificado NFPA 1970 y NIOSH en México: estructural, industrial 60 min, CBRN y RIT. Plataforma modular, localizador Pak-Tracker y EPIC 3. Refacciones originales.',
  founding: '1932',
  ...
  credenciales: [
    ...
    { n: '04', t: 'Mantenimiento NFPA 1850', d: 'El programa que exige la norma: prueba de flujo anual, hidrostática de cilindros, mantenimiento de reguladores y refacciones originales con bitácora para tu expediente de auditoría.' },
  ],
  linesIntro:
  ...
  anatomia: [
    ...
    { t: 'Cilindro de fibra de carbono 4500 psi', d: 'Suministro de aire en configuraciones de 30, 45 y 60 minutos, ligero y sujeto a prueba hidrostática periódica conforme a NFPA 1850.' },
  ...
  faqs: [
    ...
    { q: '¿Qué mantenimiento exige un SCBA y cada cuánto?', a: 'La NFPA 1850 establece el programa: prueba de flujo al menos anual, inspección del usuario antes de cada uso, prueba hidrostática del cilindro de fibra de carbono cada 5 años (vida útil de 15 años) y mantenimiento de reguladores según fabricante.' },
