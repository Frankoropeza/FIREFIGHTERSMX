...
const scottAirPak: EquipmentBrand = {
  ...
  credenciales: [
    ...
    { n: '04', t: 'Servicio técnico autorizado', d: 'Somos servicio autorizado: prueba de flujo anual, hidrostática de cilindros, mantenimiento de reguladores y refacciones originales con bitácora NFPA 1850 para tu expediente de auditoría.' },
  ],
  linesIntro:
