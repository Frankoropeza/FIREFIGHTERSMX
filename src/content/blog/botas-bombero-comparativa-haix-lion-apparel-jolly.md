...
**Resistencia al calor de la suela.** Revisa en la ficha del modelo el ensayo térmico y la condición de uso declarada. La suela debe conservar su función de barrera ante las superficies calientes previstas para el tipo de operación.
...
*La membrana, el sellado de costuras y la construcción deben revisarse en la ficha del modelo. No asumas que dos materiales con nombres similares ofrecen la misma protección.*

**Gore-Tex® Crosstech®:** membrana empleada en algunas configuraciones de calzado. Solicita la ficha del modelo para confirmar impermeabilidad, resistencia a fluidos, transpirabilidad y condiciones de garantía.

**SympaTex®:** membrana disponible en algunas configuraciones. Confirma impermeabilidad, transpirabilidad y resistencia a fluidos en la ficha específica antes de comparar materiales.

**Membranas propietarias del fabricante (Jolly-Tex, etc.):** revisa el desempeño y las condiciones de garantía de cada configuración. El nombre comercial no sustituye la documentación técnica ni la inspección periódica.

**La regla práctica:** elige la membrana con base en el riesgo, la frecuencia de uso, el programa de inspección y las condiciones de garantía documentadas.
...
El Fire Hero Xtreme es un modelo de calzado estructural. La selección debe partir de la norma declarada, la construcción, la talla y la compatibilidad con el pantalón estructural.

- **Material exterior:** confirmar material y tratamiento en la ficha vigente.
- **Membrana:** confirmar la configuración y el sellado de costuras.
- **Suela:** revisar resistencia al calor, hidrocarburos, agarre y desgaste.
- **Sistema de confort:** probar con la talla, calcetín y plantilla definidos por la corporación.
- **Estabilizador de tobillo:** evaluar ajuste y movilidad con una prueba de uso.
- **Interfaz con pantalón:** verificar que no deje huecos durante los movimientos de trabajo.

**HAIX Fire Eagle — la variante ligera**

Para operaciones donde la agilidad es prioritaria, compara el modelo con el riesgo y la norma aplicable; no uses un calzado estructural como sustituto automático de uno forestal o de rescate técnico.

| Modelo | Caña | Peso | Membrana | Protec. metatarso | Norma | Referencia comercial |
|---|---|---|---|---|---|---|
| HAIX Fire Hero Xtreme | — | — | Confirmar ficha vigente | Confirmar ficha vigente | Confirmar ficha vigente | Solicitar cotización |
| HAIX Fire Eagle | — | — | Confirmar ficha vigente | Confirmar ficha vigente | Confirmar ficha vigente | Solicitar cotización |
| HAIX Fire Flash | — | — | Confirmar ficha vigente | Confirmar ficha vigente | Confirmar ficha vigente | Solicitar cotización |
