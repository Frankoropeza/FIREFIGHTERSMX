...
El error más común es pensar que el simulacro empieza cuando suena la alarma. Empieza semanas antes.

La norma exige que el simulacro sea planeado dentro del programa de prevención de incendios. Eso significa que antes del ejercicio debes tener por escrito:

**El objetivo del simulacro.** No es "evacuar rápido". Es algo medible: verificar que el 100% del personal alcanza el punto de reunión en menos de X minutos, o validar que los brigadistas de combate ejecutan correctamente el protocolo de notificación al Cuerpo de Bomberos.

**El escenario hipotético.** Dónde se origina el incendio simulado, qué tipo de material involucra, en qué turno ocurre. Esto define qué rutas están disponibles y qué brigadas activan.

**Las rutas de evacuación activas.** Debes tener el plano del centro de trabajo con rutas marcadas y validar antes del ejercicio que están libres de obstáculos.
...
El día del simulacro, alguien debe estar documentando en tiempo real. No después. En tiempo real.

Esto incluye:

La hora exacta en que activaste la alarma o la señal de inicio. La hora en que el último trabajador llegó al punto de reunión. El tiempo total de evacuación por área o por turno.

Las incidencias: si alguien se rezagó, si una ruta estaba bloqueada, si el equipo de comunicación falló. Las incidencias no te perjudican — al contrario, muestran que el ejercicio fue real y que tienes mecanismos de mejora.

Las acciones de la brigada: qué hizo el equipo de combate de incendios, si los brigadistas de primeros auxilios se posicionaron correctamente, si el coordinador de evacuación siguió el protocolo definido.

Y evidencia fotográfica o videográfica fechada y geolocalizada, no solo bonita para redes, sino con metadatos que acrediten cuándo y dónde se tomó.

## Expediente mínimo del simulacro

Este es el expediente que debes poder presentar en una revisión de STPS o Protección Civil:

| Documento | Contenido mínimo | Cuándo se genera |
|---|---|---|
...
## El error de documentar después: por qué no vale

Muchos coordinadores piensan que pueden reconstruir el expediente a posteriori si saben lo que pasó. Es un error que puede salirte caro.
...
Cuando llegue la autoridad, el expediente del simulacro debe ser parte del programa integral de prevención de incendios, no un documento suelto que sacas de un cajón.
...
Si no puede, tienes huecos que llenar antes de que los encuentre el inspector.
