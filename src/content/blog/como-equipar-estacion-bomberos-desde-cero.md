...
La regla que nunca rompo: ninguna intervención arranca sin proteger antes a quien la ejecuta. Por eso todo el equipamiento se ordena según qué tan directamente protege la vida del personal, no según qué cuesta más ni qué luce mejor en el inventario.
...
| 6 | Extintores y sistemas | Prevención y ataque inicial |

## ¿Contra qué va a pelear tu estación?
...
Te voy a ser honesto: no existe una cifra única que te sirva, porque depende del tamaño de tu plantilla y de tu perfil de riesgo. Lo que sí funciona es armar el presupuesto por bloques y por elemento. Así puedes escalar la compra en etapas sin dejar nunca a la gente a medio proteger.
...
## Para abrir operación, esto no puede faltar

- [ ] EPP estructural completo por elemento, bien tallado y certificado
- [ ] SCBA por elemento, más cilindros de repuesto
- [ ] Un set de herramienta de forzamiento manual
- [ ] Al menos un set de rescate vehicular por unidad
- [ ] Una cámara térmica por turno
- [ ] Extintores certificados en estación y unidades
- [ ] Plan de mantenimiento y refacciones ya contratado
