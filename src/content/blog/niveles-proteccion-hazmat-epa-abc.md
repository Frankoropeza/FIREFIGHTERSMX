...
## Por qué la EPA, y no la NOM, define cómo trabajamos
...
Eso, en esencia, es todo el sistema. El resto es contexto, escenario y criterio.
...
- El agente es desconocido y hay evidencia de vapores o gases en el área
- El agente está identificado, es altamente tóxico por inhalación (IDLH bajo), y además se absorbe por piel
- Concentraciones en zona caliente por encima del IDLH confirmadas con PID/FID
...
## Nivel B: La mitad del sistema que nadie practica bien

El Nivel B ofrece exactamente la misma protección respiratoria que el Nivel A —SCBA de presión positiva— pero reduce la protección dérmica. El traje no es encapsulado. Es un traje splash: protege contra líquidos y salpicaduras, no contra vapores. Y el SCBA va **fuera** del traje, sobre la espalda.

Eso es todo el Nivel B: SCBA adentro del cuerpo, traje alrededor del cuerpo, pero sin sello hermético. El cuello, las muñecas y los pies tienen cierres, pero el traje no está diseñado para resistir permeación de vapores concentrados.

**Cuándo es el nivel correcto:**

- El agente está identificado y **no representa riesgo por absorción dérmica de vapor** —pero sí existe riesgo de salpicaduras de líquido
- Las concentraciones en zona caliente son desconocidas o pueden ser altas, por lo tanto necesitas SCBA, pero la vía dérmica de vapor no es el vector dominante
...
El error en dirección opuesta —mandar Nivel A donde B es suficiente— es un desperdicio de recursos con consecuencias reales. El equipo entra más lento, trabaja menos tiempo, necesita más rotaciones, y los trajes encapsulados de la corporación tienen vida útil limitada.
...
## Nivel C: El que más se malusa —y las tres condiciones que nadie puede saltarse

El Nivel C mantiene la misma protección dérmica que el B —traje splash— pero sustituye el SCBA por un respirador purificador de aire. Puede ser un APR de cara completa con cartuchos específicos, o un PAPR con capucha y motor de ventilación.

La diferencia fundamental: en Nivel C no llevas tu propio suministro de aire. Filtas el aire del ambiente. Eso significa que si el aire del ambiente tiene concentraciones por encima de lo que el cartucho puede manejar, o tiene un agente para el que el cartucho no está diseñado, estás respirando contaminante.

Por eso existe una regla de tres condiciones que no son negociables. Las tres tienen que cumplirse simultáneamente. Si falta una sola, el nivel mínimo es B.

### Las tres condiciones como lista de verificación de campo

**Condición 1: El agente está identificado con certeza.**
...
## Nivel D: Una sola cosa importa, y es esta

El Nivel D es ropa de trabajo normal: uniforme, botas de seguridad, guantes de trabajo, lentes. Sin protección respiratoria especializada, sin traje químico.

Una sola cosa que tienes que saber sobre el Nivel D en contexto HAZMAT: **nunca en zona caliente. Jamás. Sin excepción.**

El Nivel D es para la zona fría. Para el comandante en el puesto de mando. Para el administrativo que coordina recursos en el perímetro exterior. Para el personal de rehabilitación en zona confirmada como limpia.

El error que veo en corporaciones pequeñas es usar Nivel D para "operaciones de observación" cerca del perímetro de zona tibia. No existe tal cosa. Si estás en zona tibia, llevas como mínimo Nivel C —con las tres condiciones cumplidas. Si no puedes cumplir las tres condiciones, llevas B.

La pregunta correcta para el Nivel D no es "¿qué tan cerca puedo estar?". Es "¿estoy confirmado en zona fría, sin riesgo de contaminación accidental?". Si la respuesta no es un sí inequívoco, el Nivel D no aplica.

---

## El error que más vidas ha costado: bajar de nivel antes de que el monitoreo confirme
...
Lo que el comandante no tenía en ese momento: una lectura de PID calibrado en la zona de trabajo posterior al incidente inicial, que confirmara que las concentraciones de vapor habían bajado por debajo del IDLH.
...
Si no tienes ese dato, el equipo sigue en el nivel original o sale. No hay término medio.
...
|---|---|---|---|---|
| **Protección respiratoria** | SCBA presión positiva (interno) | SCBA presión positiva (externo) | APR / PAPR con cartuchos | Ninguna |
| **Protección dérmica** | Encapsulado total (vapor) | Splash (no encapsulado) | Splash (no encapsulado) | Ropa de trabajo |
| **Agente identificado** | No requerido | Recomendable | Obligatorio | N/A |
...
## Normas mexicanas que debes conocer

México no tiene un equivalente directo al sistema EPA A-B-C-D en una sola norma, pero estas referencias son las que encontrarás en auditorías, licitaciones públicas, y requerimientos de ASEA y STPS:

**NOM-005-STPS-1998** — Manejo, transporte y almacenamiento de sustancias químicas peligrosas. Define obligaciones del patrón en instalaciones fijas, incluyendo EPP para trabajadores expuestos.

**NOM-018-STPS-2015** — Sistema armonizado GHS/SGA para identificación y comunicación de peligros. La que regula el etiquetado y las hojas de datos de seguridad en México. Si estás en campo y tienes la SDS, esta norma define el formato.
...
## Protocolo de selección en campo: cinco pasos sin academicismo
...
## El error más caro que veo en corporaciones: comprar el traje sin comprar el sistema
...
Cuando el tiempo presiona, cuando el propietario de la instalación te está llamando, cuando la prensa está en el perímetro, cuando el equipo lleva 30 minutos esperando en zona tibia: el nivel de protección no baja hasta que el instrumento lo confirma.

No el olor. No la apariencia visual. No el reporte verbal del equipo que ya está adentro y que lleva 20 minutos respirando por la nariz.

El instrumento calibrado, con fecha de vigencia, en el punto de trabajo, operado por personal que sabe leerlo, dice que la concentración bajó del IDLH. Eso es lo único que autoriza una descalada de nivel.

Todo lo demás es presión. Y la presión en HAZMAT es el mecanismo principal por el que los respondedores se convierten en víctimas.
