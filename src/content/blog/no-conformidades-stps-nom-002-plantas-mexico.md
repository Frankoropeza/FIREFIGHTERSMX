...
## 2. Dotación incorrecta por área

El cálculo de extintores no es "uno por piso". La NOM-002 establece criterios por tipo de riesgo, área de cobertura (hasta 15 m de desplazamiento) y agente extintor según la clase de fuego probable.
...
Las salidas de emergencia tapadas con tarimas, cajas, montacargas estacionados a media noche. El inspector lo documenta con fotografías y el argumento de "fue solo un momento" no aplica en el acta.

La señalización también cuenta: flechas direccionales, señales de salida con iluminación de emergencia, y distancias visibles desde cualquier punto del área de trabajo.

## 4. Sistema fijo sin mantenimiento documentado

Si tu planta tiene rociadores, red hidrante o sistema de supresión, la norma exige mantenimiento periódico con evidencia documental. La falla más común: el mantenimiento se hace, pero no se conserva el registro firmado por la empresa que lo realizó.

Sin la documentación, para el inspector es como si no se hubiera hecho.

## 5. Programa de prevención de incendios desactualizado o inexistente

La NOM-002 requiere un programa escrito que incluya análisis de riesgo, medidas preventivas, procedimientos de respuesta y roles asignados. Muchas plantas tienen el documento, pero tiene fecha de 2018 y no refleja los cambios de layout, materiales o procesos que ocurrieron después.

Un programa desactualizado no es una no-conformidad menor. Para el inspector, es evidencia de que nadie lo opera.
...
La red de detección existe, pero ¿cuándo fue la última prueba? La norma requiere que el sistema de alarma se pruebe periódicamente y que haya registro de esa prueba. Inspectores que activan el detector durante la visita y no suena nada generan una no-conformidad crítica.

También cuenta la integración: detectores que no están conectados a la central de alarma porque "se desconectaron en la remodelación" y nadie los reconectó.

## 8. Expediente de seguridad contra incendio incompleto
