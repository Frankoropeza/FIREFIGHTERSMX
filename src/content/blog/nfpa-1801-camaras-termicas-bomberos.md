...
## Qué es la NFPA 1930 y de qué te protege

La NFPA 1930, *Standard on Thermal Imagers for the Fire Service*, es la norma técnica del National Fire Protection Association que define los requisitos mínimos de desempeño, construcción y certificación para cámaras térmicas de mano destinadas al servicio de bomberos en operaciones de supresión estructural, búsqueda y rescate.
...
## Lo que distingue una cámara certificada NFPA 1930 adentro del fuego
...
Esta es la diferencia cuantificable entre una cámara certificada NFPA 1930 y una industrial típica de gama alta. Los números importan, pero lo que más importa es que los de la columna NFPA 1930 han sido verificados por un laboratorio independiente, y los de la columna industrial son declaraciones del fabricante sin verificación independiente para ese entorno.
