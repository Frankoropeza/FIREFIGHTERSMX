---
title: "NFPA 1801: Lo que nadie te dice cuando compras una cámara térmica para bomberos"
description: "Cómo distinguir una cámara térmica certificada NFPA 1801 de una industrial disfrazada. Criterios técnicos y preguntas clave para tu proceso de licitación."
pubDate: 2026-02-15
...
Una cámara termográfica FLIR E96 o una HIKMICRO Pocket tiene resolución de 640 × 480, pantalla HD, rangos de detección de temperatura amplísimos y un precio de 30 a 60 mil pesos. Una cámara certificada bajo NFPA 1801 puede tener resolución de 320 × 240 y costar el doble o el triple.
...
Lo que no aparece en la hoja técnica de esas cámaras: no han sido sometidas a la prueba de 260 °C de temperatura ambiental que exige la NFPA 1801. No han sobrevivido una caída libre desde dos metros sobre superficie de concreto. No han sido verificadas por un laboratorio independiente acreditado en ningún protocolo de servicio de bomberos.

Eso es lo que ningún evaluador no capacitado puede ver en papel. Y eso es exactamente lo que este artículo busca resolver.

---

## Qué es la NFPA 1801 y de qué te protege

La NFPA 1801, *Standard on Thermal Imagers for the Fire Service*, es la norma técnica del National Fire Protection Association que define los requisitos mínimos de desempeño, construcción y certificación para cámaras térmicas de mano destinadas al servicio de bomberos en operaciones de supresión estructural, búsqueda y rescate.

No es una guía de buenas prácticas. Es un protocolo de pruebas objetivas ejecutadas por laboratorios de tercera parte acreditados. El fabricante no puede autocertificarse. El distribuidor no puede emitir el certificado. Únicamente el laboratorio acreditado que realizó las pruebas puede emitirlo.

La diferencia con una hoja de especificaciones técnicas es radical: una especificación declara lo que el fabricante diseñó. Una certificación NFPA 1801 demuestra lo que el equipo sobrevivió bajo condiciones controladas e independientes.
...
## Lo que distingue una cámara certificada NFPA 1801 adentro del fuego
...
La NFPA 1801 establece requisitos para el tiempo de arranque (*cold start*) de la cámara: el equipo debe estar operativo en un tiempo máximo definido desde el encendido en frío. En una situación de emergencia donde cada segundo cuenta, un equipo que tarda 30 o 45 segundos en calibrar y mostrar imagen estable es un equipo que puede costarte la localización de una víctima.
...
## La tabla que debes llevar a cualquier evaluación técnica

Esta es la diferencia cuantificable entre una cámara certificada NFPA 1801 y una industrial típica de gama alta. Los números importan, pero lo que más importa es que los de la columna NFPA 1801 han sido verificados por un laboratorio independiente, y los de la columna industrial son declaraciones del fabricante sin verificación independiente para ese entorno.

| Parámetro | Cámara industrial típica | NFPA 1801 (mínimo certificado) |
|---|---|---|
...
## Las tres ediciones de la NFPA 1801: por qué el año importa

La NFPA 1801 ha sido publicada en tres ediciones con diferencias técnicas relevantes. Especificar solo "certificación NFPA 1801" sin edición es un vacío legal que algunos proveedores conocen y explotan.
...
Si el pliego dice "NFPA 1801" sin edición, un proveedor puede presentar un certificado de 2010 y estar dentro de lo que pediste técnicamente. Para cerrar ese vacío, usa esta redacción en cualquier especificación técnica: *"certificación vigente bajo NFPA 1801, edición 2021, emitida por laboratorio de tercera parte acreditado."* Esas doce palabras eliminan la laguna.
...
Es el fraude más común y el más difícil de detectar para un evaluador sin experiencia. El distribuidor emite un documento con membrete propio que declara que la cámara "cumple con los requerimientos de la NFPA 1801" o que está "diseñada según los estándares de la NFPA 1801". El documento se ve formal. Tiene firmas, sellos, números de referencia.

No tiene ningún valor normativo.

La certificación NFPA 1801 solo puede ser emitida por el laboratorio acreditado que realizó las pruebas. No puede ser transferida, endosada ni reemitida por ningún intermediario. Una carta de cumplimiento del distribuidor no es evidencia de certificación; es evidencia de que no hay certificación real que presentar.

### "Cumple especificaciones similares a NFPA 1801"
...
La certificación NFPA 1801 no certifica especificaciones de diseño. Certifica que un modelo específico pasó pruebas específicas ejecutadas por un laboratorio independiente. Son cosas fundamentalmente distintas.

### El modelo descontinuado con certificación real

Aquí hay un matiz importante: algunos distribuidores presentan modelos que sí tienen —o tuvieron— certificación NFPA 1801, pero que ya fueron descontinuados por el fabricante. El modelo apareció en el registro público en algún momento. El distribuidor aún tiene inventario.
...
## Checklist de verificación para el comprador: 10 puntos no negociables

Esta lista está diseñada para ejecutarse antes de evaluar cualquier propuesta técnica de cámara térmica para bomberos. Si algún punto no puede verificarse, la propuesta no califica.
...
## Cómo redactar la cláusula técnica en una licitación pública bajo LAASSP

México no tiene una NOM que regule las cámaras térmicas para bomberos. La STPS no ha emitido regulación técnica específica para este equipo. Ese vacío normativo ha sido el argumento de muchos compradores para no exigir certificación formal, bajo el razonamiento de que "no hay obligación legal".
...
> *El equipo ofertado deberá contar con certificación vigente emitida por organismo de tercera parte acreditado bajo la norma NFPA 1801, Standard on Thermal Imagers for the Fire Service, edición 2021. El licitante deberá presentar el certificado original o copia legible emitida directamente por el organismo certificador, con número de parte que corresponda exactamente al modelo ofertado. No se aceptarán declaraciones de cumplimiento del fabricante ni del distribuidor en sustitución del certificado de tercera parte. El número de certificado deberá ser verificable en el registro público en línea del organismo certificador.*
...
4. Verificar que la norma listada sea NFPA 1801 y que la edición corresponda a lo especificado.
...
## Recomendaciones concretas para el jefe de corporación o responsable de adquisición
...
**En la vida útil del equipo:** Establece una política de reemplazo de baterías con componentes del fabricante o equivalentes certificados. Una batería de reemplazo genérica en una cámara certificada NFPA 1801 puede invalidar el comportamiento que la certificación garantizó.
