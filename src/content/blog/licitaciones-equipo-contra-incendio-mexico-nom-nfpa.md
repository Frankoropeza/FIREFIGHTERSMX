...
Comprar equipo de bombero no es comprar sillas de oficina ni papelería. Aquí el objeto de la compra es, literalmente, equipo del que depende la vida de una persona. Eso cambia las reglas en tres frentes. La norma no es opcional, es obligatoria y verificable. La certificación no se declara de palabra, se demuestra con evidencia de fábrica. Y la trazabilidad (marca, modelo, lote, origen) tiene que poder auditarse, porque tarde o temprano alguien la va a auditar.

Cuando alguno de estos tres elementos falta o queda redactado de forma ambigua, pasan dos cosas malas a la vez: la licitación se vuelve impugnable y la entrega, peligrosa.

## Las normas que tu convocatoria debe nombrar

Una especificación bien hecha ata cada partida a su norma, con todo y edición. Estas son las referencias que más se usan en México:
